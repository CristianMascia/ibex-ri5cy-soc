...
create_clock -add -name sys_clk_pin -period 10 -waveform {0 5} [get_ports {IO_CLK}];

#Maximum Synthesizable Clock Frequency
#create_clock -add -name sys_clk_pin -period 8.35 -waveform {0 5} [get_ports {IO_CLK}];
