...
void Vibex_demo_system::eval_step() {
    VL_DEBUG_IF(VL_DBG_MSGF("+++++TOP Evaluate Vibex_demo_system::eval\n"); );
    Vibex_demo_system__Syms* __restrict vlSymsp = this->__VlSymsp;  // Setup global symbol table
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("system_verilog_files/src/ibex_demo_system.sv", 18, "",
...
void Vibex_demo_system::_eval_initial_loop(Vibex_demo_system__Syms* __restrict vlSymsp) {
...
void Vibex_demo_system::__Vdpiexp_ibex_demo_system__DOT__mhpmcounter_get_TOP(Vibex_demo_system__Syms* __restrict vlSymsp, IData/*31:0*/ index, QData/*63:0*/ (&mhpmcounter_get__Vfuncrtn)) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vibex_demo_system::__Vdpiexp_ibex_demo_system__DOT__mhpmcounter_get_TOP\n"); );
    // Variables
    Vibex_demo_system* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    mhpmcounter_get__Vfuncrtn = vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__mhpmcounter
        [(0x1fU & index)];
}

void Vibex_demo_system::__Vdpiexp_ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__gen_prefetch_buffer__DOT__simutil_get_scramble_key_TOP(Vibex_demo_system__Syms* __restrict vlSymsp, WData/*127:0*/ (&val)[4], IData/*31:0*/ (&simutil_get_scramble_key__Vfuncrtn)) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vibex_demo_system::__Vdpiexp_ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__gen_prefetch_buffer__DOT__simutil_get_scramble_key_TOP\n"); );
    // Variables
    Vibex_demo_system* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
void Vibex_demo_system::__Vdpiexp_ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__gen_prefetch_buffer__DOT__simutil_get_scramble_nonce_TOP(Vibex_demo_system__Syms* __restrict vlSymsp, WData/*319:0*/ (&nonce)[10], IData/*31:0*/ (&simutil_get_scramble_nonce__Vfuncrtn)) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vibex_demo_system::__Vdpiexp_ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__gen_prefetch_buffer__DOT__simutil_get_scramble_nonce_TOP\n"); );
    // Variables
    Vibex_demo_system* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
void Vibex_demo_system::__Vdpiexp_ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__simutil_memload_TOP(Vibex_demo_system__Syms* __restrict vlSymsp, std::string file) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vibex_demo_system::__Vdpiexp_ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__simutil_memload_TOP\n"); );
    // Variables
    Vibex_demo_system* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    VL_READMEM_N(true, 32, 16384, 0, VL_CVT_PACK_STR_NN(file)
                 , vlTOPp->ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem
                 , 0, ~0ULL);
}

void Vibex_demo_system::__Vdpiexp_ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__simutil_set_mem_TOP(Vibex_demo_system__Syms* __restrict vlSymsp, IData/*31:0*/ index, WData/*311:0*/ val[10], IData/*31:0*/ (&simutil_set_mem__Vfuncrtn)) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vibex_demo_system::__Vdpiexp_ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__simutil_set_mem_TOP\n"); );
    // Variables
    Vibex_demo_system* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    {
        {
            if (VL_LTES_III(1,32,32, 0x4000U, index)) {
                simutil_set_mem__Vfuncrtn = 0U;
                goto __Vlabel2;
            }
            vlTOPp->ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem[(0x3fffU 
                                                                        & index)] 
                = val[0U];
...
void Vibex_demo_system::__Vdpiexp_ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__simutil_get_mem_TOP(Vibex_demo_system__Syms* __restrict vlSymsp, IData/*31:0*/ index, WData/*311:0*/ (&val)[10], IData/*31:0*/ (&simutil_get_mem__Vfuncrtn)) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vibex_demo_system::__Vdpiexp_ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__simutil_get_mem_TOP\n"); );
    // Variables
    Vibex_demo_system* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    {
        {
            ...
            val[8U] = 0U;
            val[9U] = 0U;
            val[0U] = vlTOPp->ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem
                [(0x3fffU & index)];
...
unsigned long long Vibex_demo_system::mhpmcounter_get(int index) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vibex_demo_system::mhpmcounter_get\n"); );
    // Variables
    ...
    Vibex_demo_system__Vcb_mhpmcounter_get_t __Vcb = (Vibex_demo_system__Vcb_mhpmcounter_get_t)(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    index__Vcvt = index;
    (*__Vcb)((Vibex_demo_system__Syms*)(__Vscopep->symsp()), index__Vcvt, mhpmcounter_get__Vfuncrtn__Vcvt);
...
int Vibex_demo_system::simutil_get_scramble_key(svBitVecVal* val) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vibex_demo_system::simutil_get_scramble_key\n"); );
    // Variables
    WData/*127:0*/ val__Vcvt[4];
    ...
    const VerilatedScope* __Vscopep = Verilated::dpiScope();
    Vibex_demo_system__Vcb_simutil_get_scramble_key_t __Vcb = (Vibex_demo_system__Vcb_simutil_get_scramble_key_t)(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    (*__Vcb)((Vibex_demo_system__Syms*)(__Vscopep->symsp()), val__Vcvt, simutil_get_scramble_key__Vfuncrtn__Vcvt);
...
int Vibex_demo_system::simutil_get_scramble_nonce(svBitVecVal* nonce) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vibex_demo_system::simutil_get_scramble_nonce\n"); );
    // Variables
    WData/*319:0*/ nonce__Vcvt[10];
    ...
    const VerilatedScope* __Vscopep = Verilated::dpiScope();
    Vibex_demo_system__Vcb_simutil_get_scramble_nonce_t __Vcb = (Vibex_demo_system__Vcb_simutil_get_scramble_nonce_t)(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    (*__Vcb)((Vibex_demo_system__Syms*)(__Vscopep->symsp()), nonce__Vcvt, simutil_get_scramble_nonce__Vfuncrtn__Vcvt);
...
void Vibex_demo_system::simutil_memload(const char* file) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vibex_demo_system::simutil_memload\n"); );
    // Variables
    std::string file__Vcvt;
    // Body
    static int __Vfuncnum = -1;
    if (VL_UNLIKELY(__Vfuncnum==-1)) { __Vfuncnum = Verilated::exportFuncNum("simutil_memload"); }
    const VerilatedScope* __Vscopep = Verilated::dpiScope();
    Vibex_demo_system__Vcb_simutil_memload_t __Vcb = (Vibex_demo_system__Vcb_simutil_memload_t)(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    file__Vcvt = file;
    (*__Vcb)((Vibex_demo_system__Syms*)(__Vscopep->symsp()), file__Vcvt);
}

int Vibex_demo_system::simutil_set_mem(int index, const svBitVecVal* val) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vibex_demo_system::simutil_set_mem\n"); );
    // Variables
    IData/*31:0*/ index__Vcvt;
    WData/*311:0*/ val__Vcvt[10];
    IData/*31:0*/ simutil_set_mem__Vfuncrtn__Vcvt;
    // Body
    static int __Vfuncnum = -1;
    if (VL_UNLIKELY(__Vfuncnum==-1)) { __Vfuncnum = Verilated::exportFuncNum("simutil_set_mem"); }
    const VerilatedScope* __Vscopep = Verilated::dpiScope();
    Vibex_demo_system__Vcb_simutil_set_mem_t __Vcb = (Vibex_demo_system__Vcb_simutil_set_mem_t)(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    index__Vcvt = index;
    VL_SET_W_SVBV(312,val__Vcvt,val);(*__Vcb)((Vibex_demo_system__Syms*)(__Vscopep->symsp()), index__Vcvt, val__Vcvt, simutil_set_mem__Vfuncrtn__Vcvt);
    int simutil_set_mem__Vfuncrtn;
    simutil_set_mem__Vfuncrtn = simutil_set_mem__Vfuncrtn__Vcvt;
    return simutil_set_mem__Vfuncrtn;
}

int Vibex_demo_system::simutil_get_mem(int index, svBitVecVal* val) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vibex_demo_system::simutil_get_mem\n"); );
    // Variables
    IData/*31:0*/ index__Vcvt;
    WData/*311:0*/ val__Vcvt[10];
    ...
    const VerilatedScope* __Vscopep = Verilated::dpiScope();
    Vibex_demo_system__Vcb_simutil_get_mem_t __Vcb = (Vibex_demo_system__Vcb_simutil_get_mem_t)(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    index__Vcvt = index;
    (*__Vcb)((Vibex_demo_system__Syms*)(__Vscopep->symsp()), index__Vcvt, val__Vcvt, simutil_get_mem__Vfuncrtn__Vcvt);
...
VL_INLINE_OPT void Vibex_demo_system::_sequent__TOP__4(Vibex_demo_system__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vibex_demo_system::_sequent__TOP__4\n"); );
    Vibex_demo_system* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    if (vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__trst_n) {
        ...
        vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_req__DOT__fifo_rptr_sync_q 
        ...
        vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__address_q = 0U;
        vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__data_q = 0U;
        vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_req__DOT__fifo_rptr_sync_q = 0U;
        vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__dtmcs_q = 0U;
        vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__dr_q = 0ULL;
    }
    if (vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__trst_n) {
        if (vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_req__DOT__fifo_incr_wptr) {
            vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_req__DOT__fifo_wptr_q 
                = vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_req__DOT__fifo_wptr_d;
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_req__DOT__fifo_wptr_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__trst_n) {
        ...
        vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__state_q = 0U;
        vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__error_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__trst_n) {
        if ((1U & (~ (IData)(vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_resp__DOT__empty_rclk)))) {
            vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_resp__DOT__fifo_rptr_q 
                = vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_resp__DOT__fifo_rptr_d;
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_resp__DOT__fifo_rptr_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__trst_n) {
        vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_req__DOT__fifo_rptr_gray_sync 
            = vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_req__DOT__sync_rptr__DOT__intq;
        vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_resp__DOT__fifo_wptr_gray_sync 
            = vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_resp__DOT__sync_wptr__DOT__intq;
    } else {
        vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_req__DOT__fifo_rptr_gray_sync = 0U;
        vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_resp__DOT__fifo_wptr_gray_sync = 0U;
    }
    ...
    vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_req__DOT__fifo_rptr_sync_combi 
        = vlTOPp->__Vfunc_ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_req__DOT__g_full_gray_conversion__DOT__gray2dec__40__Vfuncout;
    vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_req__DOT__sync_rptr__DOT__intq 
        = ((IData)(vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__trst_n)
            ? (IData)(vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_req__DOT__fifo_rptr_gray_q)
            : 0U);
    ...
    vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_resp__DOT__sync_wptr__DOT__intq 
        = ((IData)(vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__trst_n)
            ? (IData)(vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_resp__DOT__fifo_wptr_gray_q)
            : 0U);
    vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__dr_d 
        = vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__dr_q;
    if (vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_jtag_tap__DOT__capture_dr) {
...
VL_INLINE_OPT void Vibex_demo_system::_sequent__TOP__5(Vibex_demo_system__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vibex_demo_system::_sequent__TOP__5\n"); );
    Vibex_demo_system* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Variables
    CData/*7:0*/ __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__0__KET____DOT__u_pwm__DOT__counter;
    CData/*7:0*/ __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__1__KET____DOT__u_pwm__DOT__counter;
    CData/*7:0*/ __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__2__KET____DOT__u_pwm__DOT__counter;
    CData/*7:0*/ __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__3__KET____DOT__u_pwm__DOT__counter;
    CData/*7:0*/ __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__4__KET____DOT__u_pwm__DOT__counter;
    CData/*7:0*/ __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__5__KET____DOT__u_pwm__DOT__counter;
    CData/*7:0*/ __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__6__KET____DOT__u_pwm__DOT__counter;
    CData/*7:0*/ __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__7__KET____DOT__u_pwm__DOT__counter;
    CData/*7:0*/ __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__8__KET____DOT__u_pwm__DOT__counter;
    CData/*7:0*/ __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__9__KET____DOT__u_pwm__DOT__counter;
    CData/*7:0*/ __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__10__KET____DOT__u_pwm__DOT__counter;
    CData/*7:0*/ __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__11__KET____DOT__u_pwm__DOT__counter;
    CData/*7:0*/ __Vdly__ibex_demo_system__DOT__u_uart__DOT__u_rx_fifo__DOT__gen_normal_fifo__DOT__fifo_rptr;
    CData/*7:0*/ __Vdly__ibex_demo_system__DOT__u_uart__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__fifo_rptr;
    CData/*7:0*/ __Vdly__ibex_demo_system__DOT__u_spi__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__fifo_rptr;
    CData/*0:0*/ __Vdly__ibex_demo_system__DOT__u_spi__DOT__u_spi_host__DOT__count;
    CData/*7:0*/ __Vdly__ibex_demo_system__DOT__u_spi__DOT__u_spi_host__DOT__recieved_byte_q;
    CData/*2:0*/ __Vdly__ibex_demo_system__DOT__u_simulator_ctrl__DOT__sim_finish;
    CData/*1:0*/ __Vdly__ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__i_fifo__DOT__gen_normal_fifo__DOT__fifo_rptr;
    // Body
    __Vdly__ibex_demo_system__DOT__u_spi__DOT__u_spi_host__DOT__count 
        = vlTOPp->ibex_demo_system__DOT__u_spi__DOT__u_spi_host__DOT__count;
    __Vdly__ibex_demo_system__DOT__u_spi__DOT__u_spi_host__DOT__recieved_byte_q 
        = vlTOPp->ibex_demo_system__DOT__u_spi__DOT__u_spi_host__DOT__recieved_byte_q;
    vlTOPp->__Vdly__ibex_demo_system__DOT__u_uart__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__fifo_wptr 
        = vlTOPp->ibex_demo_system__DOT__u_uart__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__fifo_wptr;
    __Vdly__ibex_demo_system__DOT__u_uart__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__fifo_rptr 
        = vlTOPp->ibex_demo_system__DOT__u_uart__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__fifo_rptr;
    vlTOPp->__Vdly__ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__i_fifo__DOT__gen_normal_fifo__DOT__fifo_wptr 
        = vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__i_fifo__DOT__gen_normal_fifo__DOT__fifo_wptr;
    __Vdly__ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__i_fifo__DOT__gen_normal_fifo__DOT__fifo_rptr 
        = vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__i_fifo__DOT__gen_normal_fifo__DOT__fifo_rptr;
    __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__11__KET____DOT__u_pwm__DOT__counter 
        = vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__11__KET____DOT__u_pwm__DOT__counter;
    __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__10__KET____DOT__u_pwm__DOT__counter 
        = vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__10__KET____DOT__u_pwm__DOT__counter;
    __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__9__KET____DOT__u_pwm__DOT__counter 
        = vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__9__KET____DOT__u_pwm__DOT__counter;
    __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__8__KET____DOT__u_pwm__DOT__counter 
        = vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__8__KET____DOT__u_pwm__DOT__counter;
    __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__7__KET____DOT__u_pwm__DOT__counter 
        = vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__7__KET____DOT__u_pwm__DOT__counter;
    __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__6__KET____DOT__u_pwm__DOT__counter 
        = vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__6__KET____DOT__u_pwm__DOT__counter;
    __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__5__KET____DOT__u_pwm__DOT__counter 
        = vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__5__KET____DOT__u_pwm__DOT__counter;
    __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__4__KET____DOT__u_pwm__DOT__counter 
        = vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__4__KET____DOT__u_pwm__DOT__counter;
    __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__3__KET____DOT__u_pwm__DOT__counter 
        = vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__3__KET____DOT__u_pwm__DOT__counter;
    __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__2__KET____DOT__u_pwm__DOT__counter 
        = vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__2__KET____DOT__u_pwm__DOT__counter;
    __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__1__KET____DOT__u_pwm__DOT__counter 
        = vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__1__KET____DOT__u_pwm__DOT__counter;
    __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__0__KET____DOT__u_pwm__DOT__counter 
        = vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__0__KET____DOT__u_pwm__DOT__counter;
    vlTOPp->__Vdly__ibex_demo_system__DOT__u_spi__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__fifo_wptr 
        = vlTOPp->ibex_demo_system__DOT__u_spi__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__fifo_wptr;
    __Vdly__ibex_demo_system__DOT__u_spi__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__fifo_rptr 
        = vlTOPp->ibex_demo_system__DOT__u_spi__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__fifo_rptr;
    vlTOPp->__Vdly__ibex_demo_system__DOT__u_uart__DOT__u_rx_fifo__DOT__gen_normal_fifo__DOT__fifo_wptr 
        = vlTOPp->ibex_demo_system__DOT__u_uart__DOT__u_rx_fifo__DOT__gen_normal_fifo__DOT__fifo_wptr;
    __Vdly__ibex_demo_system__DOT__u_uart__DOT__u_rx_fifo__DOT__gen_normal_fifo__DOT__fifo_rptr 
        = vlTOPp->ibex_demo_system__DOT__u_uart__DOT__u_rx_fifo__DOT__gen_normal_fifo__DOT__fifo_rptr;
    __Vdly__ibex_demo_system__DOT__u_simulator_ctrl__DOT__sim_finish 
        = vlTOPp->ibex_demo_system__DOT__u_simulator_ctrl__DOT__sim_finish;
    if (vlTOPp->rst_sys_ni) {
        if (vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_req__DOT__fifo_incr_rptr) {
            vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_req__DOT__fifo_rptr_gray_q 
                = vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_req__DOT__fifo_rptr_gray_d;
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_req__DOT__fifo_rptr_gray_q = 0U;
    }
    if (vlTOPp->rst_sys_ni) {
        if (vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_resp__DOT__fifo_incr_wptr) {
            vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_resp__DOT__fifo_wptr_gray_q 
                = vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_resp__DOT__fifo_wptr_gray_d;
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_resp__DOT__fifo_wptr_gray_q = 0U;
    }
    if (vlTOPp->rst_sys_ni) {
        vlTOPp->ibex_demo_system__DOT__u_gpio__DOT__genblk1__BRA__7__KET____DOT__dbnc__DOT__cnt_q 
            = vlTOPp->ibex_demo_system__DOT__u_gpio__DOT__genblk1__BRA__7__KET____DOT__dbnc__DOT__cnt_d;
        vlTOPp->ibex_demo_system__DOT__u_gpio__DOT__genblk1__BRA__6__KET____DOT__dbnc__DOT__cnt_q 
            = vlTOPp->ibex_demo_system__DOT__u_gpio__DOT__genblk1__BRA__6__KET____DOT__dbnc__DOT__cnt_d;
        vlTOPp->ibex_demo_system__DOT__u_gpio__DOT__genblk1__BRA__5__KET____DOT__dbnc__DOT__cnt_q 
            = vlTOPp->ibex_demo_system__DOT__u_gpio__DOT__genblk1__BRA__5__KET____DOT__dbnc__DOT__cnt_d;
        vlTOPp->ibex_demo_system__DOT__u_gpio__DOT__genblk1__BRA__4__KET____DOT__dbnc__DOT__cnt_q 
            = vlTOPp->ibex_demo_system__DOT__u_gpio__DOT__genblk1__BRA__4__KET____DOT__dbnc__DOT__cnt_d;
        vlTOPp->ibex_demo_system__DOT__u_gpio__DOT__genblk1__BRA__3__KET____DOT__dbnc__DOT__cnt_q 
            = vlTOPp->ibex_demo_system__DOT__u_gpio__DOT__genblk1__BRA__3__KET____DOT__dbnc__DOT__cnt_d;
        vlTOPp->ibex_demo_system__DOT__u_gpio__DOT__genblk1__BRA__2__KET____DOT__dbnc__DOT__cnt_q 
            = vlTOPp->ibex_demo_system__DOT__u_gpio__DOT__genblk1__BRA__2__KET____DOT__dbnc__DOT__cnt_d;
        vlTOPp->ibex_demo_system__DOT__u_gpio__DOT__genblk1__BRA__1__KET____DOT__dbnc__DOT__cnt_q 
            = vlTOPp->ibex_demo_system__DOT__u_gpio__DOT__genblk1__BRA__1__KET____DOT__dbnc__DOT__cnt_d;
        vlTOPp->ibex_demo_system__DOT__u_gpio__DOT__genblk1__BRA__0__KET____DOT__dbnc__DOT__cnt_q 
            = vlTOPp->ibex_demo_system__DOT__u_gpio__DOT__genblk1__BRA__0__KET____DOT__dbnc__DOT__cnt_d;
    } else {
        vlTOPp->ibex_demo_system__DOT__u_gpio__DOT__genblk1__BRA__7__KET____DOT__dbnc__DOT__cnt_q = 0U;
        vlTOPp->ibex_demo_system__DOT__u_gpio__DOT__genblk1__BRA__6__KET____DOT__dbnc__DOT__cnt_q = 0U;
        vlTOPp->ibex_demo_system__DOT__u_gpio__DOT__genblk1__BRA__5__KET____DOT__dbnc__DOT__cnt_q = 0U;
        vlTOPp->ibex_demo_system__DOT__u_gpio__DOT__genblk1__BRA__4__KET____DOT__dbnc__DOT__cnt_q = 0U;
        vlTOPp->ibex_demo_system__DOT__u_gpio__DOT__genblk1__BRA__3__KET____DOT__dbnc__DOT__cnt_q = 0U;
        vlTOPp->ibex_demo_system__DOT__u_gpio__DOT__genblk1__BRA__2__KET____DOT__dbnc__DOT__cnt_q = 0U;
        vlTOPp->ibex_demo_system__DOT__u_gpio__DOT__genblk1__BRA__1__KET____DOT__dbnc__DOT__cnt_q = 0U;
        vlTOPp->ibex_demo_system__DOT__u_gpio__DOT__genblk1__BRA__0__KET____DOT__dbnc__DOT__cnt_q = 0U;
    }
    if (vlTOPp->rst_sys_ni) {
        if (vlTOPp->ibex_demo_system__DOT__u_spi__DOT__u_spi_host__DOT__sck_pos) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_spi__DOT__u_spi_host__DOT__bit_counter_q = 0U;
    }
    if (vlTOPp->rst_sys_ni) {
        if ((1U & (~ (IData)(vlTOPp->ibex_demo_system__DOT__u_spi__DOT__u_spi_host__DOT__sck_pos)))) {
            if (vlTOPp->ibex_demo_system__DOT__u_spi__DOT__u_spi_host__DOT__sck_neg) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_spi__DOT__u_spi_host__DOT__current_byte_q = 0U;
    }
    vlTOPp->ibex_demo_system__DOT__u_spi__DOT__next_tx_byte_q 
        = ((IData)(vlTOPp->rst_sys_ni) & (IData)(vlTOPp->ibex_demo_system__DOT__u_spi__DOT__next_tx_byte_d));
    if (vlTOPp->rst_sys_ni) {
        vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_resp__DOT__fifo_rptr_sync_q 
        ...
        vlTOPp->ibex_demo_system__DOT__u_ram__DOT__b_rvalid_o 
            = ((IData)(vlTOPp->ibex_demo_system__DOT__mem_instr_req) 
               & 1U);
    } else {
        vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_resp__DOT__fifo_rptr_sync_q = 0U;
        vlTOPp->ibex_demo_system__DOT__u_ram__DOT__b_rvalid_o = 0U;
    }
    vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__havereset_q 
        = (1U & ((~ (IData)(vlTOPp->rst_sys_ni)) | (IData)(vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__havereset_d_aligned)));
    if (vlTOPp->rst_sys_ni) {
        if ((0x1b1U == (IData)(vlTOPp->ibex_demo_system__DOT__u_uart__DOT__tx_baud_counter_q))) {
            vlTOPp->ibex_demo_system__DOT__u_uart__DOT__tx_bit_counter_q 
                = vlTOPp->ibex_demo_system__DOT__u_uart__DOT__tx_bit_counter_d;
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__u_uart__DOT__tx_bit_counter_q = 0U;
    }
    if (vlTOPp->rst_sys_ni) {
        if ((0x1b1U == (IData)(vlTOPp->ibex_demo_system__DOT__u_uart__DOT__tx_baud_counter_q))) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_uart__DOT__tx_current_byte_q = 0U;
    }
    if (vlTOPp->rst_sys_ni) {
        if (((IData)(vlTOPp->ibex_demo_system__DOT__u_uart__DOT__rx_start) 
        ...
        vlTOPp->ibex_demo_system__DOT__u_uart__DOT__rx_bit_counter_q = 0U;
    }
    vlTOPp->ibex_demo_system__DOT__u_uart__DOT__rx_q 
        = ((IData)(vlTOPp->rst_sys_ni) ? ((6U & ((IData)(vlTOPp->ibex_demo_system__DOT__u_uart__DOT__rx_q) 
                                                 << 1U)) 
                                          | (IData)(vlTOPp->uart_rx_i))
            : 0U);
    if (vlTOPp->rst_sys_ni) {
        if (vlTOPp->ibex_demo_system__DOT__u_spi__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__under_rst) {
            vlTOPp->ibex_demo_system__DOT__u_spi__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__under_rst 
                = (1U & (~ (IData)(vlTOPp->ibex_demo_system__DOT__u_spi__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__under_rst)));
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__u_spi__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__under_rst = 1U;
    }
    if (vlTOPp->rst_sys_ni) {
        if (vlTOPp->ibex_demo_system__DOT__u_uart__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__under_rst) {
            vlTOPp->ibex_demo_system__DOT__u_uart__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__under_rst 
                = (1U & (~ (IData)(vlTOPp->ibex_demo_system__DOT__u_uart__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__under_rst)));
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__u_uart__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__under_rst = 1U;
    }
    if (vlTOPp->rst_sys_ni) {
        if ((0x1b1U == (IData)(vlTOPp->ibex_demo_system__DOT__u_uart__DOT__tx_baud_counter_q))) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_uart__DOT__tx_state_q = 0U;
    }
    __Vdly__ibex_demo_system__DOT__u_spi__DOT__u_spi_host__DOT__count 
        = ((IData)(vlTOPp->rst_sys_ni) & (((2U == (IData)(vlTOPp->ibex_demo_system__DOT__u_spi__DOT__u_spi_host__DOT__state_q)) 
                                           | (IData)(vlTOPp->ibex_demo_system__DOT__u_spi__DOT__tx_fifo_rvalid)) 
                                          & ((~ (IData)(vlTOPp->ibex_demo_system__DOT__u_spi__DOT__u_spi_host__DOT__count_at_limit)) 
                                             & ((IData)(1U) 
                                                + (IData)(vlTOPp->ibex_demo_system__DOT__u_spi__DOT__u_spi_host__DOT__count)))));
    if (vlTOPp->rst_sys_ni) {
        if (((2U == (IData)(vlTOPp->ibex_demo_system__DOT__u_spi__DOT__u_spi_host__DOT__state_q)) 
             | (IData)(vlTOPp->ibex_demo_system__DOT__u_spi__DOT__tx_fifo_rvalid))) {
            if ((1U <= (IData)(vlTOPp->ibex_demo_system__DOT__u_spi__DOT__u_spi_host__DOT__count))) {
                vlTOPp->ibex_demo_system__DOT__u_spi__DOT__u_spi_host__DOT__sck 
                    = (1U & (~ (IData)(vlTOPp->ibex_demo_system__DOT__u_spi__DOT__u_spi_host__DOT__sck)));
            }
        } else {
            vlTOPp->ibex_demo_system__DOT__u_spi__DOT__u_spi_host__DOT__sck = 0U;
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__u_spi__DOT__u_spi_host__DOT__sck = 0U;
    }
    if (vlTOPp->rst_sys_ni) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_uart__DOT__rx_state_q = 0U;
    }
    if (vlTOPp->rst_sys_ni) {
        if (vlTOPp->ibex_demo_system__DOT__u_spi__DOT__u_spi_host__DOT__sck_pos) {
            __Vdly__ibex_demo_system__DOT__u_spi__DOT__u_spi_host__DOT__recieved_byte_q 
                = vlTOPp->ibex_demo_system__DOT__u_spi__DOT__u_spi_host__DOT__recieved_byte_d;
        }
    } else {
        __Vdly__ibex_demo_system__DOT__u_spi__DOT__u_spi_host__DOT__recieved_byte_q = 0U;
    }
    if (vlTOPp->rst_sys_ni) {
        vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_resp__DOT__fifo_rptr_gray_sync 
            = vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_resp__DOT__sync_rptr__DOT__intq;
        vlTOPp->ibex_demo_system__DOT__u_timer__DOT__mtime_q 
            = vlTOPp->ibex_demo_system__DOT__u_timer__DOT__mtime_d;
    } else {
        vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_resp__DOT__fifo_rptr_gray_sync = 0U;
        vlTOPp->ibex_demo_system__DOT__u_timer__DOT__mtime_q = 0ULL;
    }
    if (vlTOPp->rst_sys_ni) {
        if (((IData)(vlTOPp->ibex_demo_system__DOT__u_timer__DOT__mtimecmp_we) 
        ...
        vlTOPp->ibex_demo_system__DOT__u_timer__DOT__mtimecmp_q = 0ULL;
    }
    if (vlTOPp->rst_sys_ni) {
        if (vlTOPp->ibex_demo_system__DOT__u_uart__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__u_fifo_cnt__DOT__wptr_wrap) {
            vlTOPp->__Vdly__ibex_demo_system__DOT__u_uart__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__fifo_wptr 
                = vlTOPp->ibex_demo_system__DOT__u_uart__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__u_fifo_cnt__DOT__wptr_wrap_cnt;
        } else {
            if (vlTOPp->ibex_demo_system__DOT__u_uart__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__fifo_incr_wptr) {
                vlTOPp->__Vdly__ibex_demo_system__DOT__u_uart__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__fifo_wptr 
                    = (0xffU & ((IData)(1U) + (IData)(vlTOPp->ibex_demo_system__DOT__u_uart__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__fifo_wptr)));
            }
        }
    } else {
        vlTOPp->__Vdly__ibex_demo_system__DOT__u_uart__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__fifo_wptr = 0U;
    }
    if (vlTOPp->rst_sys_ni) {
        if (vlTOPp->ibex_demo_system__DOT__u_uart__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__u_fifo_cnt__DOT__rptr_wrap) {
            __Vdly__ibex_demo_system__DOT__u_uart__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__fifo_rptr 
                = vlTOPp->ibex_demo_system__DOT__u_uart__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__u_fifo_cnt__DOT__rptr_wrap_cnt;
        } else {
            if (vlTOPp->ibex_demo_system__DOT__u_uart__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__fifo_incr_rptr) {
                __Vdly__ibex_demo_system__DOT__u_uart__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__fifo_rptr 
                    = (0xffU & ((IData)(1U) + (IData)(vlTOPp->ibex_demo_system__DOT__u_uart__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__fifo_rptr)));
            }
        }
    } else {
        __Vdly__ibex_demo_system__DOT__u_uart__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__fifo_rptr = 0U;
    }
    vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_mem__DOT__state_q 
        = ((IData)(vlTOPp->rst_sys_ni) ? (IData)(vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_mem__DOT__state_d)
            : 0U);
    if (vlTOPp->rst_sys_ni) {
        if (vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__i_fifo__DOT__gen_normal_fifo__DOT__under_rst) {
            vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__i_fifo__DOT__gen_normal_fifo__DOT__under_rst 
                = (1U & (~ (IData)(vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__i_fifo__DOT__gen_normal_fifo__DOT__under_rst)));
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__i_fifo__DOT__gen_normal_fifo__DOT__under_rst = 1U;
    }
    if (vlTOPp->rst_sys_ni) {
        if (vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_req__DOT__fifo_incr_rptr) {
            vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_req__DOT__fifo_rptr_q 
                = vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_req__DOT__fifo_rptr_d;
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_req__DOT__fifo_rptr_q = 0U;
    }
    vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_req__DOT__fifo_wptr_gray_sync 
        = ((IData)(vlTOPp->rst_sys_ni) ? (IData)(vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_req__DOT__sync_wptr__DOT__intq)
            : 0U);
    if (vlTOPp->rst_sys_ni) {
        if (vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__i_fifo__DOT__gen_normal_fifo__DOT__u_fifo_cnt__DOT__wptr_wrap) {
            vlTOPp->__Vdly__ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__i_fifo__DOT__gen_normal_fifo__DOT__fifo_wptr 
            ...
            if (vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__i_fifo__DOT__gen_normal_fifo__DOT__fifo_incr_wptr) {
                vlTOPp->__Vdly__ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__i_fifo__DOT__gen_normal_fifo__DOT__fifo_wptr 
                    = (3U & ((IData)(1U) + (IData)(vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__i_fifo__DOT__gen_normal_fifo__DOT__fifo_wptr)));
            }
        }
    } else {
        vlTOPp->__Vdly__ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__i_fifo__DOT__gen_normal_fifo__DOT__fifo_wptr = 0U;
    }
    if (vlTOPp->rst_sys_ni) {
        if (vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__i_fifo__DOT__gen_normal_fifo__DOT__u_fifo_cnt__DOT__rptr_wrap) {
            __Vdly__ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__i_fifo__DOT__gen_normal_fifo__DOT__fifo_rptr 
            ...
            if (vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__i_fifo__DOT__gen_normal_fifo__DOT__fifo_incr_rptr) {
                __Vdly__ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__i_fifo__DOT__gen_normal_fifo__DOT__fifo_rptr 
                    = (3U & ((IData)(1U) + (IData)(vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__i_fifo__DOT__gen_normal_fifo__DOT__fifo_rptr)));
            }
        }
    } else {
        __Vdly__ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__i_fifo__DOT__gen_normal_fifo__DOT__fifo_rptr = 0U;
    }
    vlTOPp->ibex_demo_system__DOT__core_instr_sel_dbg 
        = ((IData)(vlTOPp->rst_sys_ni) & (IData)(vlTOPp->ibex_demo_system__DOT__dbg_instr_req));
    vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_mem__DOT__resuming_q 
        = ((IData)(vlTOPp->rst_sys_ni) & ((~ (vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__dmcontrol_q 
                                              >> 1U)) 
    ...
    if (vlTOPp->rst_sys_ni) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_gpio__DOT__gp_i_q 
            = ((0xffff00U & (vlTOPp->ibex_demo_system__DOT__u_gpio__DOT__gp_i_q 
                             << 8U)) | (IData)(vlTOPp->gp_i));
    } else {
        vlTOPp->ibex_demo_system__DOT__u_uart__DOT__device_rdata_q = 0U;
        vlTOPp->ibex_demo_system__DOT__u_gpio__DOT__gp_i_q = 0U;
    }
    if (vlTOPp->rst_sys_ni) {
        if ((0U == (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__11__KET____DOT__counter_q))) {
            __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__11__KET____DOT__u_pwm__DOT__counter = 0U;
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT____Vcellout__gen_pwm__BRA__11__KET____DOT__u_pwm__modulated_o = 0U;
        } else {
            __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__11__KET____DOT__u_pwm__DOT__counter 
                = (((IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__11__KET____DOT__u_pwm__DOT__counter) 
                    < (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__11__KET____DOT__counter_q))
                    ? (0xffU & ((IData)(1U) + (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__11__KET____DOT__u_pwm__DOT__counter)))
                    : 0U);
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT____Vcellout__gen_pwm__BRA__11__KET____DOT__u_pwm__modulated_o 
                = ((IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__11__KET____DOT__pulse_width_q) 
                   > (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__11__KET____DOT__u_pwm__DOT__counter));
        }
    } else {
        __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__11__KET____DOT__u_pwm__DOT__counter = 0U;
    ...
    if (vlTOPp->rst_sys_ni) {
        if ((0U == (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__10__KET____DOT__counter_q))) {
            __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__10__KET____DOT__u_pwm__DOT__counter = 0U;
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT____Vcellout__gen_pwm__BRA__10__KET____DOT__u_pwm__modulated_o = 0U;
        } else {
            __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__10__KET____DOT__u_pwm__DOT__counter 
                = (((IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__10__KET____DOT__u_pwm__DOT__counter) 
                    < (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__10__KET____DOT__counter_q))
                    ? (0xffU & ((IData)(1U) + (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__10__KET____DOT__u_pwm__DOT__counter)))
                    : 0U);
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT____Vcellout__gen_pwm__BRA__10__KET____DOT__u_pwm__modulated_o 
                = ((IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__10__KET____DOT__pulse_width_q) 
                   > (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__10__KET____DOT__u_pwm__DOT__counter));
        }
    } else {
        __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__10__KET____DOT__u_pwm__DOT__counter = 0U;
    ...
    if (vlTOPp->rst_sys_ni) {
        if ((0U == (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__9__KET____DOT__counter_q))) {
            __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__9__KET____DOT__u_pwm__DOT__counter = 0U;
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT____Vcellout__gen_pwm__BRA__9__KET____DOT__u_pwm__modulated_o = 0U;
        } else {
            __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__9__KET____DOT__u_pwm__DOT__counter 
                = (((IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__9__KET____DOT__u_pwm__DOT__counter) 
                    < (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__9__KET____DOT__counter_q))
                    ? (0xffU & ((IData)(1U) + (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__9__KET____DOT__u_pwm__DOT__counter)))
                    : 0U);
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT____Vcellout__gen_pwm__BRA__9__KET____DOT__u_pwm__modulated_o 
                = ((IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__9__KET____DOT__pulse_width_q) 
                   > (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__9__KET____DOT__u_pwm__DOT__counter));
        }
    } else {
        __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__9__KET____DOT__u_pwm__DOT__counter = 0U;
    ...
    if (vlTOPp->rst_sys_ni) {
        if ((0U == (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__8__KET____DOT__counter_q))) {
            __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__8__KET____DOT__u_pwm__DOT__counter = 0U;
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT____Vcellout__gen_pwm__BRA__8__KET____DOT__u_pwm__modulated_o = 0U;
        } else {
            __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__8__KET____DOT__u_pwm__DOT__counter 
                = (((IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__8__KET____DOT__u_pwm__DOT__counter) 
                    < (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__8__KET____DOT__counter_q))
                    ? (0xffU & ((IData)(1U) + (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__8__KET____DOT__u_pwm__DOT__counter)))
                    : 0U);
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT____Vcellout__gen_pwm__BRA__8__KET____DOT__u_pwm__modulated_o 
                = ((IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__8__KET____DOT__pulse_width_q) 
                   > (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__8__KET____DOT__u_pwm__DOT__counter));
        }
    } else {
        __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__8__KET____DOT__u_pwm__DOT__counter = 0U;
    ...
    if (vlTOPp->rst_sys_ni) {
        if ((0U == (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__7__KET____DOT__counter_q))) {
            __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__7__KET____DOT__u_pwm__DOT__counter = 0U;
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT____Vcellout__gen_pwm__BRA__7__KET____DOT__u_pwm__modulated_o = 0U;
        } else {
            __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__7__KET____DOT__u_pwm__DOT__counter 
                = (((IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__7__KET____DOT__u_pwm__DOT__counter) 
                    < (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__7__KET____DOT__counter_q))
                    ? (0xffU & ((IData)(1U) + (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__7__KET____DOT__u_pwm__DOT__counter)))
                    : 0U);
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT____Vcellout__gen_pwm__BRA__7__KET____DOT__u_pwm__modulated_o 
                = ((IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__7__KET____DOT__pulse_width_q) 
                   > (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__7__KET____DOT__u_pwm__DOT__counter));
        }
    } else {
        __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__7__KET____DOT__u_pwm__DOT__counter = 0U;
    ...
    if (vlTOPp->rst_sys_ni) {
        if ((0U == (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__6__KET____DOT__counter_q))) {
            __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__6__KET____DOT__u_pwm__DOT__counter = 0U;
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT____Vcellout__gen_pwm__BRA__6__KET____DOT__u_pwm__modulated_o = 0U;
        } else {
            __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__6__KET____DOT__u_pwm__DOT__counter 
                = (((IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__6__KET____DOT__u_pwm__DOT__counter) 
                    < (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__6__KET____DOT__counter_q))
                    ? (0xffU & ((IData)(1U) + (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__6__KET____DOT__u_pwm__DOT__counter)))
                    : 0U);
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT____Vcellout__gen_pwm__BRA__6__KET____DOT__u_pwm__modulated_o 
                = ((IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__6__KET____DOT__pulse_width_q) 
                   > (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__6__KET____DOT__u_pwm__DOT__counter));
        }
    } else {
        __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__6__KET____DOT__u_pwm__DOT__counter = 0U;
    ...
    if (vlTOPp->rst_sys_ni) {
        if ((0U == (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__5__KET____DOT__counter_q))) {
            __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__5__KET____DOT__u_pwm__DOT__counter = 0U;
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT____Vcellout__gen_pwm__BRA__5__KET____DOT__u_pwm__modulated_o = 0U;
        } else {
            __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__5__KET____DOT__u_pwm__DOT__counter 
                = (((IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__5__KET____DOT__u_pwm__DOT__counter) 
                    < (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__5__KET____DOT__counter_q))
                    ? (0xffU & ((IData)(1U) + (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__5__KET____DOT__u_pwm__DOT__counter)))
                    : 0U);
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT____Vcellout__gen_pwm__BRA__5__KET____DOT__u_pwm__modulated_o 
                = ((IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__5__KET____DOT__pulse_width_q) 
                   > (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__5__KET____DOT__u_pwm__DOT__counter));
        }
    } else {
        __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__5__KET____DOT__u_pwm__DOT__counter = 0U;
    ...
    if (vlTOPp->rst_sys_ni) {
        if ((0U == (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__4__KET____DOT__counter_q))) {
            __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__4__KET____DOT__u_pwm__DOT__counter = 0U;
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT____Vcellout__gen_pwm__BRA__4__KET____DOT__u_pwm__modulated_o = 0U;
        } else {
            __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__4__KET____DOT__u_pwm__DOT__counter 
                = (((IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__4__KET____DOT__u_pwm__DOT__counter) 
                    < (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__4__KET____DOT__counter_q))
                    ? (0xffU & ((IData)(1U) + (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__4__KET____DOT__u_pwm__DOT__counter)))
                    : 0U);
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT____Vcellout__gen_pwm__BRA__4__KET____DOT__u_pwm__modulated_o 
                = ((IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__4__KET____DOT__pulse_width_q) 
                   > (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__4__KET____DOT__u_pwm__DOT__counter));
        }
    } else {
        __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__4__KET____DOT__u_pwm__DOT__counter = 0U;
    ...
    if (vlTOPp->rst_sys_ni) {
        if ((0U == (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__3__KET____DOT__counter_q))) {
            __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__3__KET____DOT__u_pwm__DOT__counter = 0U;
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT____Vcellout__gen_pwm__BRA__3__KET____DOT__u_pwm__modulated_o = 0U;
        } else {
            __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__3__KET____DOT__u_pwm__DOT__counter 
                = (((IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__3__KET____DOT__u_pwm__DOT__counter) 
                    < (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__3__KET____DOT__counter_q))
                    ? (0xffU & ((IData)(1U) + (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__3__KET____DOT__u_pwm__DOT__counter)))
                    : 0U);
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT____Vcellout__gen_pwm__BRA__3__KET____DOT__u_pwm__modulated_o 
                = ((IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__3__KET____DOT__pulse_width_q) 
                   > (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__3__KET____DOT__u_pwm__DOT__counter));
        }
    } else {
        __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__3__KET____DOT__u_pwm__DOT__counter = 0U;
    ...
    if (vlTOPp->rst_sys_ni) {
        if ((0U == (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__2__KET____DOT__counter_q))) {
            __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__2__KET____DOT__u_pwm__DOT__counter = 0U;
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT____Vcellout__gen_pwm__BRA__2__KET____DOT__u_pwm__modulated_o = 0U;
        } else {
            __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__2__KET____DOT__u_pwm__DOT__counter 
                = (((IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__2__KET____DOT__u_pwm__DOT__counter) 
                    < (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__2__KET____DOT__counter_q))
                    ? (0xffU & ((IData)(1U) + (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__2__KET____DOT__u_pwm__DOT__counter)))
                    : 0U);
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT____Vcellout__gen_pwm__BRA__2__KET____DOT__u_pwm__modulated_o 
                = ((IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__2__KET____DOT__pulse_width_q) 
                   > (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__2__KET____DOT__u_pwm__DOT__counter));
        }
    } else {
        __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__2__KET____DOT__u_pwm__DOT__counter = 0U;
    ...
    if (vlTOPp->rst_sys_ni) {
        if ((0U == (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__1__KET____DOT__counter_q))) {
            __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__1__KET____DOT__u_pwm__DOT__counter = 0U;
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT____Vcellout__gen_pwm__BRA__1__KET____DOT__u_pwm__modulated_o = 0U;
        } else {
            __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__1__KET____DOT__u_pwm__DOT__counter 
                = (((IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__1__KET____DOT__u_pwm__DOT__counter) 
                    < (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__1__KET____DOT__counter_q))
                    ? (0xffU & ((IData)(1U) + (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__1__KET____DOT__u_pwm__DOT__counter)))
                    : 0U);
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT____Vcellout__gen_pwm__BRA__1__KET____DOT__u_pwm__modulated_o 
                = ((IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__1__KET____DOT__pulse_width_q) 
                   > (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__1__KET____DOT__u_pwm__DOT__counter));
        }
    } else {
        __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__1__KET____DOT__u_pwm__DOT__counter = 0U;
    ...
    if (vlTOPp->rst_sys_ni) {
        if ((0U == (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__0__KET____DOT__counter_q))) {
            __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__0__KET____DOT__u_pwm__DOT__counter = 0U;
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT____Vcellout__gen_pwm__BRA__0__KET____DOT__u_pwm__modulated_o = 0U;
        } else {
            __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__0__KET____DOT__u_pwm__DOT__counter 
                = (((IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__0__KET____DOT__u_pwm__DOT__counter) 
                    < (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__0__KET____DOT__counter_q))
                    ? (0xffU & ((IData)(1U) + (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__0__KET____DOT__u_pwm__DOT__counter)))
                    : 0U);
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT____Vcellout__gen_pwm__BRA__0__KET____DOT__u_pwm__modulated_o 
                = ((IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__0__KET____DOT__pulse_width_q) 
                   > (IData)(vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__0__KET____DOT__u_pwm__DOT__counter));
        }
    } else {
        __Vdly__ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__0__KET____DOT__u_pwm__DOT__counter = 0U;
    ...
    vlTOPp->ibex_demo_system__DOT__u_spi__DOT__read_status_q 
        = ((IData)(vlTOPp->rst_sys_ni) & ((vlTOPp->ibex_demo_system__DOT__device_req
                                           [5U] & (4U 
                                                   == 
                                                   (0xfffU 
                                          ...
                                          & (~ vlTOPp->ibex_demo_system__DOT__device_we
                                             [5U])));
    vlTOPp->ibex_demo_system__DOT__u_gpio__DOT__gp_i_dbnc_rd_en_q 
        = ((IData)(vlTOPp->rst_sys_ni) & ((vlTOPp->ibex_demo_system__DOT__device_req
                                           [1U] & (~ 
                                                   vlTOPp->ibex_demo_system__DOT__device_we
                                                   [1U])) 
                                          & (8U == 
                                             (0xfffU 
                                              & vlTOPp->ibex_demo_system__DOT__device_addr
                                              [1U]))));
    vlTOPp->ibex_demo_system__DOT__u_gpio__DOT__gp_i_rd_en_q 
        = ((IData)(vlTOPp->rst_sys_ni) & ((vlTOPp->ibex_demo_system__DOT__device_req
                                           [1U] & (~ 
                                                   vlTOPp->ibex_demo_system__DOT__device_we
                                                   [1U])) 
                                          & (4U == 
                                             (0xfffU 
                                              ...
                                              [1U]))));
    if (vlTOPp->rst_sys_ni) {
        if (((vlTOPp->ibex_demo_system__DOT__device_req
              [1U] & vlTOPp->ibex_demo_system__DOT__device_we
              [1U]) & (0U == (0xfffU & vlTOPp->ibex_demo_system__DOT__device_addr
                              [1U])))) {
            vlTOPp->gp_o = vlTOPp->ibex_demo_system__DOT__u_gpio__DOT__gp_o_d;
        }
    } else {
        vlTOPp->gp_o = 0U;
    }
    vlTOPp->ibex_demo_system__DOT__u_gpio__DOT__genblk1__BRA__7__KET____DOT__dbnc__DOT__btn_q 
        = ((IData)(vlTOPp->rst_sys_ni) & (IData)(vlTOPp->ibex_demo_system__DOT__u_gpio__DOT__genblk1__BRA__7__KET____DOT__dbnc__DOT__btn_d));
    vlTOPp->ibex_demo_system__DOT__u_gpio__DOT__genblk1__BRA__6__KET____DOT__dbnc__DOT__btn_q 
        = ((IData)(vlTOPp->rst_sys_ni) & (IData)(vlTOPp->ibex_demo_system__DOT__u_gpio__DOT__genblk1__BRA__6__KET____DOT__dbnc__DOT__btn_d));
    vlTOPp->ibex_demo_system__DOT__u_gpio__DOT__genblk1__BRA__5__KET____DOT__dbnc__DOT__btn_q 
        = ((IData)(vlTOPp->rst_sys_ni) & (IData)(vlTOPp->ibex_demo_system__DOT__u_gpio__DOT__genblk1__BRA__5__KET____DOT__dbnc__DOT__btn_d));
    vlTOPp->ibex_demo_system__DOT__u_gpio__DOT__genblk1__BRA__4__KET____DOT__dbnc__DOT__btn_q 
        = ((IData)(vlTOPp->rst_sys_ni) & (IData)(vlTOPp->ibex_demo_system__DOT__u_gpio__DOT__genblk1__BRA__4__KET____DOT__dbnc__DOT__btn_d));
    vlTOPp->ibex_demo_system__DOT__u_gpio__DOT__genblk1__BRA__3__KET____DOT__dbnc__DOT__btn_q 
        = ((IData)(vlTOPp->rst_sys_ni) & (IData)(vlTOPp->ibex_demo_system__DOT__u_gpio__DOT__genblk1__BRA__3__KET____DOT__dbnc__DOT__btn_d));
    vlTOPp->ibex_demo_system__DOT__u_gpio__DOT__genblk1__BRA__2__KET____DOT__dbnc__DOT__btn_q 
        = ((IData)(vlTOPp->rst_sys_ni) & (IData)(vlTOPp->ibex_demo_system__DOT__u_gpio__DOT__genblk1__BRA__2__KET____DOT__dbnc__DOT__btn_d));
    vlTOPp->ibex_demo_system__DOT__u_gpio__DOT__genblk1__BRA__1__KET____DOT__dbnc__DOT__btn_q 
        = ((IData)(vlTOPp->rst_sys_ni) & (IData)(vlTOPp->ibex_demo_system__DOT__u_gpio__DOT__genblk1__BRA__1__KET____DOT__dbnc__DOT__btn_d));
    vlTOPp->ibex_demo_system__DOT__u_gpio__DOT__genblk1__BRA__0__KET____DOT__dbnc__DOT__btn_q 
        = ((IData)(vlTOPp->rst_sys_ni) & (IData)(vlTOPp->ibex_demo_system__DOT__u_gpio__DOT__genblk1__BRA__0__KET____DOT__dbnc__DOT__btn_d));
    vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_mem__DOT__word_enable32_q 
        = ((IData)(vlTOPp->rst_sys_ni) & (vlTOPp->ibex_demo_system__DOT__dbg_slave_addr 
                                          >> 2U));
    if (vlTOPp->rst_sys_ni) {
        if (vlTOPp->ibex_demo_system__DOT__u_spi__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__u_fifo_cnt__DOT__wptr_wrap) {
            vlTOPp->__Vdly__ibex_demo_system__DOT__u_spi__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__fifo_wptr 
                = vlTOPp->ibex_demo_system__DOT__u_spi__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__u_fifo_cnt__DOT__wptr_wrap_cnt;
        } else {
            if (vlTOPp->ibex_demo_system__DOT__u_spi__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__fifo_incr_wptr) {
                vlTOPp->__Vdly__ibex_demo_system__DOT__u_spi__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__fifo_wptr 
                    = (0xffU & ((IData)(1U) + (IData)(vlTOPp->ibex_demo_system__DOT__u_spi__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__fifo_wptr)));
            }
        }
    } else {
        vlTOPp->__Vdly__ibex_demo_system__DOT__u_spi__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__fifo_wptr = 0U;
    }
    if (vlTOPp->rst_sys_ni) {
        if (vlTOPp->ibex_demo_system__DOT__u_spi__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__u_fifo_cnt__DOT__rptr_wrap) {
            __Vdly__ibex_demo_system__DOT__u_spi__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__fifo_rptr 
                = vlTOPp->ibex_demo_system__DOT__u_spi__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__u_fifo_cnt__DOT__rptr_wrap_cnt;
        } else {
            if (vlTOPp->ibex_demo_system__DOT__u_spi__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__fifo_incr_rptr) {
                __Vdly__ibex_demo_system__DOT__u_spi__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__fifo_rptr 
                    = (0xffU & ((IData)(1U) + (IData)(vlTOPp->ibex_demo_system__DOT__u_spi__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__fifo_rptr)));
            }
        }
    } else {
        __Vdly__ibex_demo_system__DOT__u_spi__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__fifo_rptr = 0U;
    }
    if (vlTOPp->rst_sys_ni) {
        ...
        vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_mem__DOT__fwd_rom_q 
            = ((0x800U <= (0xfffU & vlTOPp->ibex_demo_system__DOT__dbg_slave_addr)) 
               & 1U);
        vlTOPp->ibex_demo_system__DOT__u_timer__DOT__interrupt_q 
            = ((IData)(vlTOPp->ibex_demo_system__DOT__u_timer__DOT__interrupt_d) 
               & 1U);
    } else {
        vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_mem__DOT__rdata_q = 0ULL;
        vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_mem__DOT__fwd_rom_q = 0U;
        vlTOPp->ibex_demo_system__DOT__u_timer__DOT__interrupt_q = 0U;
    }
    if (vlTOPp->rst_sys_ni) {
        if (vlTOPp->ibex_demo_system__DOT__u_uart__DOT__u_rx_fifo__DOT__gen_normal_fifo__DOT__under_rst) {
            vlTOPp->ibex_demo_system__DOT__u_uart__DOT__u_rx_fifo__DOT__gen_normal_fifo__DOT__under_rst 
                = (1U & (~ (IData)(vlTOPp->ibex_demo_system__DOT__u_uart__DOT__u_rx_fifo__DOT__gen_normal_fifo__DOT__under_rst)));
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__u_uart__DOT__u_rx_fifo__DOT__gen_normal_fifo__DOT__under_rst = 1U;
    }
    if (vlTOPp->rst_sys_ni) {
        if (vlTOPp->ibex_demo_system__DOT__u_uart__DOT__u_rx_fifo__DOT__gen_normal_fifo__DOT__u_fifo_cnt__DOT__wptr_wrap) {
            vlTOPp->__Vdly__ibex_demo_system__DOT__u_uart__DOT__u_rx_fifo__DOT__gen_normal_fifo__DOT__fifo_wptr 
                = vlTOPp->ibex_demo_system__DOT__u_uart__DOT__u_rx_fifo__DOT__gen_normal_fifo__DOT__u_fifo_cnt__DOT__wptr_wrap_cnt;
        } else {
            if (vlTOPp->ibex_demo_system__DOT__u_uart__DOT__u_rx_fifo__DOT__gen_normal_fifo__DOT__fifo_incr_wptr) {
                vlTOPp->__Vdly__ibex_demo_system__DOT__u_uart__DOT__u_rx_fifo__DOT__gen_normal_fifo__DOT__fifo_wptr 
                    = (0xffU & ((IData)(1U) + (IData)(vlTOPp->ibex_demo_system__DOT__u_uart__DOT__u_rx_fifo__DOT__gen_normal_fifo__DOT__fifo_wptr)));
            }
        }
    } else {
        vlTOPp->__Vdly__ibex_demo_system__DOT__u_uart__DOT__u_rx_fifo__DOT__gen_normal_fifo__DOT__fifo_wptr = 0U;
    }
    if (vlTOPp->rst_sys_ni) {
        if (vlTOPp->ibex_demo_system__DOT__u_uart__DOT__u_rx_fifo__DOT__gen_normal_fifo__DOT__u_fifo_cnt__DOT__rptr_wrap) {
            __Vdly__ibex_demo_system__DOT__u_uart__DOT__u_rx_fifo__DOT__gen_normal_fifo__DOT__fifo_rptr 
                = vlTOPp->ibex_demo_system__DOT__u_uart__DOT__u_rx_fifo__DOT__gen_normal_fifo__DOT__u_fifo_cnt__DOT__rptr_wrap_cnt;
        } else {
            if (vlTOPp->ibex_demo_system__DOT__u_uart__DOT__u_rx_fifo__DOT__gen_normal_fifo__DOT__fifo_incr_rptr) {
                __Vdly__ibex_demo_system__DOT__u_uart__DOT__u_rx_fifo__DOT__gen_normal_fifo__DOT__fifo_rptr 
                    = (0xffU & ((IData)(1U) + (IData)(vlTOPp->ibex_demo_system__DOT__u_uart__DOT__u_rx_fifo__DOT__gen_normal_fifo__DOT__fifo_rptr)));
            }
        }
    } else {
        __Vdly__ibex_demo_system__DOT__u_uart__DOT__u_rx_fifo__DOT__gen_normal_fifo__DOT__fifo_rptr = 0U;
    }
    vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_sba__DOT__state_q 
        = ((IData)(vlTOPp->rst_sys_ni) ? (IData)(vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_sba__DOT__state_d)
            : 0U);
    if (vlTOPp->rst_sys_ni) {
        if ((1U & vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__dmcontrol_q)) {
            ...
            vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__cmd_valid_q 
            ...
            vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__dmcontrol_q 
                = (0x7fffffffU & vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__dmcontrol_q);
            vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__cmderr_q = 0U;
            vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__command_q = 0U;
            vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__cmd_valid_q = 0U;
            vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__abstractauto_q = 0U;
            vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__progbuf_q[0U] = 0U;
            vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__progbuf_q[1U] = 0U;
            vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__progbuf_q[2U] = 0U;
            vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__progbuf_q[3U] = 0U;
            vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__progbuf_q[4U] = 0U;
            vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__progbuf_q[5U] = 0U;
            vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__progbuf_q[6U] = 0U;
            vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__progbuf_q[7U] = 0U;
            vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__data_q = 0ULL;
            vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__sbcs_q = 0U;
            vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__sbaddr_q = 0ULL;
            vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__sbdata_q = 0ULL;
            vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__dmcontrol_q 
                = (0xbfffffffU & vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__dmcontrol_q);
            vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__dmcontrol_q 
                = (0xdfffffffU & vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__dmcontrol_q);
            vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__dmcontrol_q 
                = (0xefffffffU & vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__dmcontrol_q);
            vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__dmcontrol_q 
                = (0xf7ffffffU & vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__dmcontrol_q);
            vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__dmcontrol_q 
                = (0xfbffffffU & vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__dmcontrol_q);
            vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__dmcontrol_q 
                = (0xfc00ffffU & vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__dmcontrol_q);
            vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__dmcontrol_q 
                = (0xffff003fU & vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__dmcontrol_q);
            vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__dmcontrol_q 
                = (0xffffffcfU & vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__dmcontrol_q);
            vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__dmcontrol_q 
                = (0xfffffff7U & vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__dmcontrol_q);
            vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__dmcontrol_q 
                = (0xfffffffbU & vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__dmcontrol_q);
            vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__dmcontrol_q 
                = (0xfffffffdU & vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__dmcontrol_q);
            vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__dmcontrol_q 
                = ((0xfffffffeU & vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__dmcontrol_q) 
                   | (1U & vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__dmcontrol_d));
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__dmcontrol_q = 0U;
        vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__cmderr_q = 0U;
        vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__command_q = 0U;
        vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__cmd_valid_q = 0U;
        vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__abstractauto_q = 0U;
    ...
    if (vlTOPp->rst_sys_ni) {
        vlTOPp->ibex_demo_system__DOT__u_bus__DOT__device_sel_resp 
            = vlTOPp->ibex_demo_system__DOT__u_bus__DOT__device_sel_req;
        vlTOPp->ibex_demo_system__DOT__u_bus__DOT__host_sel_resp 
            = ((IData)(vlTOPp->ibex_demo_system__DOT__u_bus__DOT__host_sel_req) 
               & 1U);
        vlTOPp->ibex_demo_system__DOT__u_uart__DOT__device_rvalid_q 
            = ((IData)(vlTOPp->ibex_demo_system__DOT__u_uart__DOT__device_rvalid_d) 
               & 1U);
        ...
        vlTOPp->ibex_demo_system__DOT__u_bus__DOT__device_sel_resp = 0U;
        vlTOPp->ibex_demo_system__DOT__u_bus__DOT__host_sel_resp = 0U;
        vlTOPp->ibex_demo_system__DOT__u_uart__DOT__device_rvalid_q = 0U;
        vlTOPp->ibex_demo_system__DOT__u_timer__DOT__rvalid_q = 0U;
        vlTOPp->ibex_demo_system__DOT____Vcellout__u_spi__device_rvalid_o = 0U;
        vlTOPp->ibex_demo_system__DOT____Vcellout__u_pwm__device_rvalid_o = 0U;
        vlTOPp->ibex_demo_system__DOT____Vcellout__u_gpio__device_rvalid_o = 0U;
        vlTOPp->ibex_demo_system__DOT____Vcellout__u_ram__a_rvalid_o = 0U;
        vlTOPp->ibex_demo_system__DOT__dbg_slave_rvalid = 0U;
    }
    if (vlTOPp->rst_sys_ni) {
        if ((vlTOPp->ibex_demo_system__DOT__device_req
             [6U] & vlTOPp->ibex_demo_system__DOT__device_we
             [6U])) {
            if ((0U == (0xffU & (vlTOPp->ibex_demo_system__DOT__device_addr
                                 [6U] >> 2U)))) {
                if (VL_UNLIKELY((1U & vlTOPp->ibex_demo_system__DOT__device_be
                                 [6U]))) {
                    VL_FWRITEF(vlTOPp->ibex_demo_system__DOT__u_simulator_ctrl__DOT__log_fd,"%c",
                               8,(0xffU & vlTOPp->ibex_demo_system__DOT__device_wdata
                                  [6U]));
                    if (vlTOPp->ibex_demo_system__DOT__u_simulator_ctrl__DOT__log_fd) { VL_FFLUSH_I(vlTOPp->ibex_demo_system__DOT__u_simulator_ctrl__DOT__log_fd); }
                }
            } else {
                if ((2U == (0xffU & (vlTOPp->ibex_demo_system__DOT__device_addr
                                     [6U] >> 2U)))) {
                    if (VL_UNLIKELY(((vlTOPp->ibex_demo_system__DOT__device_be
                                      [6U] & vlTOPp->ibex_demo_system__DOT__device_wdata
                                      [6U]) & (0U == (IData)(vlTOPp->ibex_demo_system__DOT__u_simulator_ctrl__DOT__sim_finish))))) {
                        VL_WRITEF("Terminating simulation by software request.\n");
                        __Vdly__ibex_demo_system__DOT__u_simulator_ctrl__DOT__sim_finish = 1U;
                    }
                }
            }
        }
        ...
        vlTOPp->ibex_demo_system__DOT____Vcellout__u_simulator_ctrl__rvalid_o = 0U;
        __Vdly__ibex_demo_system__DOT__u_simulator_ctrl__DOT__sim_finish = 0U;
    }
    if ((0U != (IData)(vlTOPp->ibex_demo_system__DOT__u_simulator_ctrl__DOT__sim_finish))) {
        __Vdly__ibex_demo_system__DOT__u_simulator_ctrl__DOT__sim_finish 
            = (7U & ((IData)(1U) + (IData)(vlTOPp->ibex_demo_system__DOT__u_simulator_ctrl__DOT__sim_finish)));
    }
    if (VL_UNLIKELY((2U <= (IData)(vlTOPp->ibex_demo_system__DOT__u_simulator_ctrl__DOT__sim_finish)))) {
        VL_FINISH_MT("system_verilog_files/src//simulator_ctrl.sv", 93, "");
    }
    vlTOPp->ibex_demo_system__DOT__u_spi__DOT__u_spi_host__DOT__count 
        = __Vdly__ibex_demo_system__DOT__u_spi__DOT__u_spi_host__DOT__count;
    vlTOPp->ibex_demo_system__DOT__u_uart__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__fifo_rptr 
    ...
    vlTOPp->ibex_demo_system__DOT__u_uart__DOT__tx_baud_counter_q 
        = ((IData)(vlTOPp->rst_sys_ni) ? (IData)(vlTOPp->ibex_demo_system__DOT__u_uart__DOT__tx_baud_counter_d)
            : 0U);
    ...
    if (vlTOPp->rst_sys_ni) {
        if ((1U & (~ (IData)(vlTOPp->ibex_demo_system__DOT__u_spi__DOT__u_spi_host__DOT__sck_pos)))) {
            if (vlTOPp->ibex_demo_system__DOT__u_spi__DOT__u_spi_host__DOT__sck_neg) {
                if ((2U == (IData)(vlTOPp->ibex_demo_system__DOT__u_spi__DOT__u_spi_host__DOT__state_q))) {
                    vlTOPp->ibex_demo_system__DOT__u_spi__DOT__u_spi_host__DOT__recieved_byte_d 
                        = ((0xfeU & ((IData)(vlTOPp->ibex_demo_system__DOT__u_spi__DOT__u_spi_host__DOT__recieved_byte_q) 
    ...
    vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_resp__DOT__fifo_rptr_sync_combi 
        = vlTOPp->__Vfunc_ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_resp__DOT__g_full_gray_conversion__DOT__gray2dec__44__Vfuncout;
    vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_resp__DOT__sync_rptr__DOT__intq 
        = ((IData)(vlTOPp->rst_sys_ni) ? (IData)(vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_resp__DOT__fifo_rptr_gray_q)
            : 0U);
    vlTOPp->ibex_demo_system__DOT__u_uart__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__u_fifo_cnt__DOT__rptr_wrap_cnt 
    ...
    vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_req__DOT__fifo_rptr_gray_d 
        = vlTOPp->__Vfunc_ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_req__DOT__g_full_gray_conversion__DOT__dec2gray__42__Vfuncout;
    vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_req__DOT__sync_wptr__DOT__intq 
        = ((IData)(vlTOPp->rst_sys_ni) ? (IData)(vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_req__DOT__fifo_wptr_gray_q)
            : 0U);
    ...
    if (vlTOPp->rst_sys_ni) {
        if ((((vlTOPp->ibex_demo_system__DOT__device_req
               ...
               [2U]) & (0xbU == (0x7fU & (vlTOPp->ibex_demo_system__DOT__device_addr
                                          [2U] >> 3U)))) 
             & (vlTOPp->ibex_demo_system__DOT__device_addr
                [2U] >> 2U))) {
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__11__KET____DOT__counter_q 
                = (0xffU & vlTOPp->ibex_demo_system__DOT__device_wdata
                   [2U]);
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__11__KET____DOT__counter_q = 0U;
    }
    if (vlTOPp->rst_sys_ni) {
        if ((((vlTOPp->ibex_demo_system__DOT__device_req
               [2U] & vlTOPp->ibex_demo_system__DOT__device_we
             ...
             & (~ (vlTOPp->ibex_demo_system__DOT__device_addr
                   [2U] >> 2U)))) {
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__11__KET____DOT__pulse_width_q 
                = (0xffU & vlTOPp->ibex_demo_system__DOT__device_wdata
                   [2U]);
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__11__KET____DOT__pulse_width_q = 0U;
    }
    ...
    if (vlTOPp->rst_sys_ni) {
        if ((((vlTOPp->ibex_demo_system__DOT__device_req
               [2U] & vlTOPp->ibex_demo_system__DOT__device_we
               [2U]) & (0xaU == (0x7fU & (vlTOPp->ibex_demo_system__DOT__device_addr
                                          [2U] >> 3U)))) 
             & (vlTOPp->ibex_demo_system__DOT__device_addr
                [2U] >> 2U))) {
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__10__KET____DOT__counter_q 
                = (0xffU & vlTOPp->ibex_demo_system__DOT__device_wdata
                   [2U]);
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__10__KET____DOT__counter_q = 0U;
    }
    if (vlTOPp->rst_sys_ni) {
        if ((((vlTOPp->ibex_demo_system__DOT__device_req
               [2U] & vlTOPp->ibex_demo_system__DOT__device_we
             ...
             & (~ (vlTOPp->ibex_demo_system__DOT__device_addr
                   [2U] >> 2U)))) {
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__10__KET____DOT__pulse_width_q 
                = (0xffU & vlTOPp->ibex_demo_system__DOT__device_wdata
                   [2U]);
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__10__KET____DOT__pulse_width_q = 0U;
    }
    ...
    if (vlTOPp->rst_sys_ni) {
        if ((((vlTOPp->ibex_demo_system__DOT__device_req
               [2U] & vlTOPp->ibex_demo_system__DOT__device_we
               [2U]) & (9U == (0x7fU & (vlTOPp->ibex_demo_system__DOT__device_addr
                                        [2U] >> 3U)))) 
             & (vlTOPp->ibex_demo_system__DOT__device_addr
                [2U] >> 2U))) {
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__9__KET____DOT__counter_q 
                = (0xffU & vlTOPp->ibex_demo_system__DOT__device_wdata
                   [2U]);
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__9__KET____DOT__counter_q = 0U;
    }
    if (vlTOPp->rst_sys_ni) {
        if ((((vlTOPp->ibex_demo_system__DOT__device_req
               [2U] & vlTOPp->ibex_demo_system__DOT__device_we
             ...
             & (~ (vlTOPp->ibex_demo_system__DOT__device_addr
                   [2U] >> 2U)))) {
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__9__KET____DOT__pulse_width_q 
                = (0xffU & vlTOPp->ibex_demo_system__DOT__device_wdata
                   [2U]);
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__9__KET____DOT__pulse_width_q = 0U;
    }
    ...
    if (vlTOPp->rst_sys_ni) {
        if ((((vlTOPp->ibex_demo_system__DOT__device_req
               [2U] & vlTOPp->ibex_demo_system__DOT__device_we
               [2U]) & (8U == (0x7fU & (vlTOPp->ibex_demo_system__DOT__device_addr
                                        [2U] >> 3U)))) 
             & (vlTOPp->ibex_demo_system__DOT__device_addr
                [2U] >> 2U))) {
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__8__KET____DOT__counter_q 
                = (0xffU & vlTOPp->ibex_demo_system__DOT__device_wdata
                   [2U]);
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__8__KET____DOT__counter_q = 0U;
    }
    if (vlTOPp->rst_sys_ni) {
        if ((((vlTOPp->ibex_demo_system__DOT__device_req
               [2U] & vlTOPp->ibex_demo_system__DOT__device_we
             ...
             & (~ (vlTOPp->ibex_demo_system__DOT__device_addr
                   [2U] >> 2U)))) {
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__8__KET____DOT__pulse_width_q 
                = (0xffU & vlTOPp->ibex_demo_system__DOT__device_wdata
                   [2U]);
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__8__KET____DOT__pulse_width_q = 0U;
    }
    ...
    if (vlTOPp->rst_sys_ni) {
        if ((((vlTOPp->ibex_demo_system__DOT__device_req
               [2U] & vlTOPp->ibex_demo_system__DOT__device_we
               [2U]) & (7U == (0x7fU & (vlTOPp->ibex_demo_system__DOT__device_addr
                                        [2U] >> 3U)))) 
             & (vlTOPp->ibex_demo_system__DOT__device_addr
                [2U] >> 2U))) {
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__7__KET____DOT__counter_q 
                = (0xffU & vlTOPp->ibex_demo_system__DOT__device_wdata
                   [2U]);
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__7__KET____DOT__counter_q = 0U;
    }
    if (vlTOPp->rst_sys_ni) {
        if ((((vlTOPp->ibex_demo_system__DOT__device_req
               [2U] & vlTOPp->ibex_demo_system__DOT__device_we
             ...
             & (~ (vlTOPp->ibex_demo_system__DOT__device_addr
                   [2U] >> 2U)))) {
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__7__KET____DOT__pulse_width_q 
                = (0xffU & vlTOPp->ibex_demo_system__DOT__device_wdata
                   [2U]);
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__7__KET____DOT__pulse_width_q = 0U;
    }
    ...
    if (vlTOPp->rst_sys_ni) {
        if ((((vlTOPp->ibex_demo_system__DOT__device_req
               [2U] & vlTOPp->ibex_demo_system__DOT__device_we
               [2U]) & (6U == (0x7fU & (vlTOPp->ibex_demo_system__DOT__device_addr
                                        [2U] >> 3U)))) 
             & (vlTOPp->ibex_demo_system__DOT__device_addr
                [2U] >> 2U))) {
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__6__KET____DOT__counter_q 
                = (0xffU & vlTOPp->ibex_demo_system__DOT__device_wdata
                   [2U]);
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__6__KET____DOT__counter_q = 0U;
    }
    if (vlTOPp->rst_sys_ni) {
        if ((((vlTOPp->ibex_demo_system__DOT__device_req
               [2U] & vlTOPp->ibex_demo_system__DOT__device_we
             ...
             & (~ (vlTOPp->ibex_demo_system__DOT__device_addr
                   [2U] >> 2U)))) {
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__6__KET____DOT__pulse_width_q 
                = (0xffU & vlTOPp->ibex_demo_system__DOT__device_wdata
                   [2U]);
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__6__KET____DOT__pulse_width_q = 0U;
    }
    ...
    if (vlTOPp->rst_sys_ni) {
        if ((((vlTOPp->ibex_demo_system__DOT__device_req
               [2U] & vlTOPp->ibex_demo_system__DOT__device_we
               [2U]) & (5U == (0x7fU & (vlTOPp->ibex_demo_system__DOT__device_addr
                                        [2U] >> 3U)))) 
             & (vlTOPp->ibex_demo_system__DOT__device_addr
                [2U] >> 2U))) {
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__5__KET____DOT__counter_q 
                = (0xffU & vlTOPp->ibex_demo_system__DOT__device_wdata
                   [2U]);
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__5__KET____DOT__counter_q = 0U;
    }
    if (vlTOPp->rst_sys_ni) {
        if ((((vlTOPp->ibex_demo_system__DOT__device_req
               [2U] & vlTOPp->ibex_demo_system__DOT__device_we
             ...
             & (~ (vlTOPp->ibex_demo_system__DOT__device_addr
                   [2U] >> 2U)))) {
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__5__KET____DOT__pulse_width_q 
                = (0xffU & vlTOPp->ibex_demo_system__DOT__device_wdata
                   [2U]);
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__5__KET____DOT__pulse_width_q = 0U;
    }
    ...
    if (vlTOPp->rst_sys_ni) {
        if ((((vlTOPp->ibex_demo_system__DOT__device_req
               [2U] & vlTOPp->ibex_demo_system__DOT__device_we
               [2U]) & (4U == (0x7fU & (vlTOPp->ibex_demo_system__DOT__device_addr
                                        [2U] >> 3U)))) 
             & (vlTOPp->ibex_demo_system__DOT__device_addr
                [2U] >> 2U))) {
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__4__KET____DOT__counter_q 
                = (0xffU & vlTOPp->ibex_demo_system__DOT__device_wdata
                   [2U]);
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__4__KET____DOT__counter_q = 0U;
    }
    if (vlTOPp->rst_sys_ni) {
        if ((((vlTOPp->ibex_demo_system__DOT__device_req
               [2U] & vlTOPp->ibex_demo_system__DOT__device_we
             ...
             & (~ (vlTOPp->ibex_demo_system__DOT__device_addr
                   [2U] >> 2U)))) {
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__4__KET____DOT__pulse_width_q 
                = (0xffU & vlTOPp->ibex_demo_system__DOT__device_wdata
                   [2U]);
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__4__KET____DOT__pulse_width_q = 0U;
    }
    ...
    if (vlTOPp->rst_sys_ni) {
        if ((((vlTOPp->ibex_demo_system__DOT__device_req
               [2U] & vlTOPp->ibex_demo_system__DOT__device_we
               [2U]) & (3U == (0x7fU & (vlTOPp->ibex_demo_system__DOT__device_addr
                                        [2U] >> 3U)))) 
             & (vlTOPp->ibex_demo_system__DOT__device_addr
                [2U] >> 2U))) {
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__3__KET____DOT__counter_q 
                = (0xffU & vlTOPp->ibex_demo_system__DOT__device_wdata
                   [2U]);
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__3__KET____DOT__counter_q = 0U;
    }
    if (vlTOPp->rst_sys_ni) {
        if ((((vlTOPp->ibex_demo_system__DOT__device_req
               [2U] & vlTOPp->ibex_demo_system__DOT__device_we
             ...
             & (~ (vlTOPp->ibex_demo_system__DOT__device_addr
                   [2U] >> 2U)))) {
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__3__KET____DOT__pulse_width_q 
                = (0xffU & vlTOPp->ibex_demo_system__DOT__device_wdata
                   [2U]);
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__3__KET____DOT__pulse_width_q = 0U;
    }
    ...
    if (vlTOPp->rst_sys_ni) {
        if ((((vlTOPp->ibex_demo_system__DOT__device_req
               [2U] & vlTOPp->ibex_demo_system__DOT__device_we
               [2U]) & (2U == (0x7fU & (vlTOPp->ibex_demo_system__DOT__device_addr
                                        [2U] >> 3U)))) 
             & (vlTOPp->ibex_demo_system__DOT__device_addr
                [2U] >> 2U))) {
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__2__KET____DOT__counter_q 
                = (0xffU & vlTOPp->ibex_demo_system__DOT__device_wdata
                   [2U]);
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__2__KET____DOT__counter_q = 0U;
    }
    if (vlTOPp->rst_sys_ni) {
        if ((((vlTOPp->ibex_demo_system__DOT__device_req
               [2U] & vlTOPp->ibex_demo_system__DOT__device_we
             ...
             & (~ (vlTOPp->ibex_demo_system__DOT__device_addr
                   [2U] >> 2U)))) {
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__2__KET____DOT__pulse_width_q 
                = (0xffU & vlTOPp->ibex_demo_system__DOT__device_wdata
                   [2U]);
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__2__KET____DOT__pulse_width_q = 0U;
    }
    ...
    if (vlTOPp->rst_sys_ni) {
        if ((((vlTOPp->ibex_demo_system__DOT__device_req
               [2U] & vlTOPp->ibex_demo_system__DOT__device_we
               [2U]) & (1U == (0x7fU & (vlTOPp->ibex_demo_system__DOT__device_addr
                                        [2U] >> 3U)))) 
             & (vlTOPp->ibex_demo_system__DOT__device_addr
                [2U] >> 2U))) {
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__1__KET____DOT__counter_q 
                = (0xffU & vlTOPp->ibex_demo_system__DOT__device_wdata
                   [2U]);
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__1__KET____DOT__counter_q = 0U;
    }
    if (vlTOPp->rst_sys_ni) {
        if ((((vlTOPp->ibex_demo_system__DOT__device_req
               [2U] & vlTOPp->ibex_demo_system__DOT__device_we
             ...
             & (~ (vlTOPp->ibex_demo_system__DOT__device_addr
                   [2U] >> 2U)))) {
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__1__KET____DOT__pulse_width_q 
                = (0xffU & vlTOPp->ibex_demo_system__DOT__device_wdata
                   [2U]);
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__1__KET____DOT__pulse_width_q = 0U;
    }
    ...
    if (vlTOPp->rst_sys_ni) {
        if ((((vlTOPp->ibex_demo_system__DOT__device_req
               [2U] & vlTOPp->ibex_demo_system__DOT__device_we
               [2U]) & (0U == (0x7fU & (vlTOPp->ibex_demo_system__DOT__device_addr
                                        [2U] >> 3U)))) 
             & (vlTOPp->ibex_demo_system__DOT__device_addr
                [2U] >> 2U))) {
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__0__KET____DOT__counter_q 
                = (0xffU & vlTOPp->ibex_demo_system__DOT__device_wdata
                   [2U]);
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__0__KET____DOT__counter_q = 0U;
    }
    if (vlTOPp->rst_sys_ni) {
        if ((((vlTOPp->ibex_demo_system__DOT__device_req
               [2U] & vlTOPp->ibex_demo_system__DOT__device_we
             ...
             & (~ (vlTOPp->ibex_demo_system__DOT__device_addr
                   [2U] >> 2U)))) {
            vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__0__KET____DOT__pulse_width_q 
                = (0xffU & vlTOPp->ibex_demo_system__DOT__device_wdata
                   [2U]);
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__u_pwm__DOT__gen_pwm__BRA__0__KET____DOT__pulse_width_q = 0U;
    }
    ...
    if (vlTOPp->rst_sys_ni) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_spi__DOT__u_spi_host__DOT__state_q = 0U;
    }
...
VL_INLINE_OPT void Vibex_demo_system::_sequent__TOP__6(Vibex_demo_system__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vibex_demo_system::_sequent__TOP__6\n"); );
    Vibex_demo_system* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Variables
    CData/*4:0*/ __Vdlyvlsb__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v0;
    CData/*7:0*/ __Vdlyvval__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v0;
    CData/*0:0*/ __Vdlyvset__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v0;
    CData/*4:0*/ __Vdlyvlsb__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v1;
    CData/*7:0*/ __Vdlyvval__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v1;
    CData/*0:0*/ __Vdlyvset__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v1;
    CData/*4:0*/ __Vdlyvlsb__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v2;
    CData/*7:0*/ __Vdlyvval__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v2;
    CData/*0:0*/ __Vdlyvset__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v2;
    CData/*4:0*/ __Vdlyvlsb__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v3;
    CData/*7:0*/ __Vdlyvval__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v3;
    CData/*0:0*/ __Vdlyvset__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v3;
    CData/*1:0*/ __Vdlyvdim0__ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_resp__DOT__storage__v0;
    CData/*0:0*/ __Vdlyvset__ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_resp__DOT__storage__v0;
    SData/*13:0*/ __Vdlyvdim0__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v0;
    SData/*13:0*/ __Vdlyvdim0__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v1;
    SData/*13:0*/ __Vdlyvdim0__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v2;
    SData/*13:0*/ __Vdlyvdim0__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v3;
    QData/*33:0*/ __Vdlyvval__ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_resp__DOT__storage__v0;
    // Body
    __Vdlyvset__ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_resp__DOT__storage__v0 = 0U;
    __Vdlyvset__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v0 = 0U;
    __Vdlyvset__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v1 = 0U;
    __Vdlyvset__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v2 = 0U;
    __Vdlyvset__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v3 = 0U;
    if (vlTOPp->ibex_demo_system__DOT__device_req[0U]) {
        if (vlTOPp->ibex_demo_system__DOT__device_we
            [0U]) {
            vlTOPp->ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__unnamedblk1__DOT__i = 4U;
        }
    }
    if (vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_resp__DOT__fifo_incr_wptr) {
        __Vdlyvval__ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_resp__DOT__storage__v0 
            = vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dmi_rsp;
        __Vdlyvset__ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_resp__DOT__storage__v0 = 1U;
        __Vdlyvdim0__ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_resp__DOT__storage__v0 
            = (3U & (IData)(vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_resp__DOT__fifo_wptr_q));
    }
    if (vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__i_fifo__DOT__gen_normal_fifo__DOT__fifo_incr_wptr) {
        vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__i_fifo__DOT__gen_normal_fifo__DOT__storage 
            = (((~ (0xffffffffULL << (0x20U & ((IData)(vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__i_fifo__DOT__gen_normal_fifo__DOT__fifo_wptr) 
                                               << 5U)))) 
                & vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__i_fifo__DOT__gen_normal_fifo__DOT__storage) 
               | ((QData)((IData)(vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__resp_queue_data)) 
                  << (0x20U & ((IData)(vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__i_fifo__DOT__gen_normal_fifo__DOT__fifo_wptr) 
                               << 5U))));
    }
    if (vlTOPp->ibex_demo_system__DOT__u_uart__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__fifo_incr_wptr) {
        VL_ASSIGNSEL_WIII(8,(0x3f8U & ((IData)(vlTOPp->ibex_demo_system__DOT__u_uart__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__fifo_wptr) 
                                       << 3U)), vlTOPp->ibex_demo_system__DOT__u_uart__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__storage, 
                          (0xffU & vlTOPp->ibex_demo_system__DOT__device_wdata
                           [3U]));
    }
    if (vlTOPp->ibex_demo_system__DOT__mem_instr_req) {
        vlTOPp->ibex_demo_system__DOT__mem_instr_rdata 
            = vlTOPp->ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem
            [(0x3fffU & (vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__gen_prefetch_buffer__DOT__prefetch_buffer_i__DOT__instr_addr 
                         >> 2U))];
    }
    if (vlTOPp->ibex_demo_system__DOT__u_spi__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__fifo_incr_wptr) {
        vlTOPp->ibex_demo_system__DOT__u_spi__DOT__u_tx_fifo__DOT____Vlvbound1 
            = (0xffU & vlTOPp->ibex_demo_system__DOT__device_wdata
               [5U]);
        if ((0x3f7U >= (0x3f8U & ((IData)(vlTOPp->ibex_demo_system__DOT__u_spi__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__fifo_wptr) 
                                  << 3U)))) {
            VL_ASSIGNSEL_WIII(8,(0x3f8U & ((IData)(vlTOPp->ibex_demo_system__DOT__u_spi__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__fifo_wptr) 
                                           << 3U)), vlTOPp->ibex_demo_system__DOT__u_spi__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__storage, vlTOPp->ibex_demo_system__DOT__u_spi__DOT__u_tx_fifo__DOT____Vlvbound1);
        }
    }
    if (vlTOPp->ibex_demo_system__DOT__device_req[4U]) {
        vlTOPp->ibex_demo_system__DOT__u_timer__DOT__rdata_q 
            = vlTOPp->ibex_demo_system__DOT__u_timer__DOT__rdata_d;
    }
    if (vlTOPp->ibex_demo_system__DOT__device_req[0U]) {
        if ((1U & (~ vlTOPp->ibex_demo_system__DOT__device_we
                   [0U]))) {
            vlTOPp->ibex_demo_system__DOT____Vcellout__u_ram__a_rdata_o 
                = vlTOPp->ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem
                [(0x3fffU & (vlTOPp->ibex_demo_system__DOT__device_addr
                             [0U] >> 2U))];
        }
    }
    if (vlTOPp->ibex_demo_system__DOT__device_req[0U]) {
        if (vlTOPp->ibex_demo_system__DOT__device_we
            [0U]) {
            if ((1U & (IData)(vlTOPp->ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__a_wmask))) {
                __Vdlyvval__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v0 
                    = (0xffU & vlTOPp->ibex_demo_system__DOT__device_wdata
                       [0U]);
                __Vdlyvset__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v0 = 1U;
                __Vdlyvlsb__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v0 = 0U;
                __Vdlyvdim0__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v0 
                    = (0x3fffU & (vlTOPp->ibex_demo_system__DOT__device_addr
                                  [0U] >> 2U));
            }
            if ((2U & (IData)(vlTOPp->ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__a_wmask))) {
                __Vdlyvval__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v1 
                    = (0xffU & (vlTOPp->ibex_demo_system__DOT__device_wdata
                                [0U] >> 8U));
                __Vdlyvset__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v1 = 1U;
                __Vdlyvlsb__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v1 = 8U;
                __Vdlyvdim0__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v1 
                    = (0x3fffU & (vlTOPp->ibex_demo_system__DOT__device_addr
                                  [0U] >> 2U));
            }
            if ((4U & (IData)(vlTOPp->ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__a_wmask))) {
                __Vdlyvval__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v2 
                    = (0xffU & (vlTOPp->ibex_demo_system__DOT__device_wdata
                                [0U] >> 0x10U));
                __Vdlyvset__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v2 = 1U;
                __Vdlyvlsb__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v2 = 0x10U;
                __Vdlyvdim0__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v2 
                    = (0x3fffU & (vlTOPp->ibex_demo_system__DOT__device_addr
                                  [0U] >> 2U));
            }
            if ((8U & (IData)(vlTOPp->ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__a_wmask))) {
                __Vdlyvval__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v3 
                    = (0xffU & (vlTOPp->ibex_demo_system__DOT__device_wdata
                                [0U] >> 0x18U));
                __Vdlyvset__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v3 = 1U;
                __Vdlyvlsb__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v3 = 0x18U;
                __Vdlyvdim0__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v3 
                    = (0x3fffU & (vlTOPp->ibex_demo_system__DOT__device_addr
                                  [0U] >> 2U));
            }
        }
    ...
    if (vlTOPp->ibex_demo_system__DOT__dbg_slave_req) {
        vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_mem__DOT__gen_rom_snd_scratch__DOT__i_debug_rom__DOT__addr_q 
            = (0x1fU & (IData)(((QData)((IData)(vlTOPp->ibex_demo_system__DOT__dbg_slave_addr)) 
                                >> 3U)));
    }
    if (vlTOPp->ibex_demo_system__DOT__u_uart__DOT__u_rx_fifo__DOT__gen_normal_fifo__DOT__fifo_incr_wptr) {
        VL_ASSIGNSEL_WIII(8,(0x3f8U & ((IData)(vlTOPp->ibex_demo_system__DOT__u_uart__DOT__u_rx_fifo__DOT__gen_normal_fifo__DOT__fifo_wptr) 
                                       << 3U)), vlTOPp->ibex_demo_system__DOT__u_uart__DOT__u_rx_fifo__DOT__gen_normal_fifo__DOT__storage, vlTOPp->ibex_demo_system__DOT__u_uart__DOT__rx_current_byte_q);
    }
    if (vlTOPp->ibex_demo_system__DOT__device_req[4U]) {
        vlTOPp->ibex_demo_system__DOT__u_timer__DOT__error_q 
            = vlTOPp->ibex_demo_system__DOT__u_timer__DOT__error_d;
    }
    if (__Vdlyvset__ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_resp__DOT__storage__v0) {
        vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_resp__DOT__storage[__Vdlyvdim0__ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_resp__DOT__storage__v0] 
            = __Vdlyvval__ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_resp__DOT__storage__v0;
    }
    if (__Vdlyvset__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v0) {
        vlTOPp->ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem[__Vdlyvdim0__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v0] 
            = (((~ ((IData)(0xffU) << (IData)(__Vdlyvlsb__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v0))) 
                & vlTOPp->ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem
                [__Vdlyvdim0__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v0]) 
               | ((IData)(__Vdlyvval__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v0) 
                  << (IData)(__Vdlyvlsb__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v0)));
    }
    if (__Vdlyvset__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v1) {
        vlTOPp->ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem[__Vdlyvdim0__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v1] 
            = (((~ ((IData)(0xffU) << (IData)(__Vdlyvlsb__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v1))) 
                & vlTOPp->ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem
                [__Vdlyvdim0__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v1]) 
               | ((IData)(__Vdlyvval__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v1) 
                  << (IData)(__Vdlyvlsb__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v1)));
    }
    if (__Vdlyvset__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v2) {
        vlTOPp->ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem[__Vdlyvdim0__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v2] 
            = (((~ ((IData)(0xffU) << (IData)(__Vdlyvlsb__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v2))) 
                & vlTOPp->ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem
                [__Vdlyvdim0__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v2]) 
               | ((IData)(__Vdlyvval__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v2) 
                  << (IData)(__Vdlyvlsb__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v2)));
    }
    if (__Vdlyvset__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v3) {
        vlTOPp->ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem[__Vdlyvdim0__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v3] 
            = (((~ ((IData)(0xffU) << (IData)(__Vdlyvlsb__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v3))) 
                & vlTOPp->ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem
                [__Vdlyvdim0__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v3]) 
               | ((IData)(__Vdlyvval__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v3) 
                  << (IData)(__Vdlyvlsb__ibex_demo_system__DOT__u_ram__DOT__u_ram__DOT__mem__v3)));
    }
...
VL_INLINE_OPT void Vibex_demo_system::_sequent__TOP__7(Vibex_demo_system__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vibex_demo_system::_sequent__TOP__7\n"); );
    Vibex_demo_system* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->ibex_demo_system__DOT__u_top__DOT__core_busy_q 
        = ((IData)(vlTOPp->ibex_demo_system__DOT__rst_core_n)
            ? ((((IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__ctrl_busy) 
...
VL_INLINE_OPT void Vibex_demo_system::_combo__TOP__8(Vibex_demo_system__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vibex_demo_system::_combo__TOP__8\n"); );
    Vibex_demo_system* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
VL_INLINE_OPT void Vibex_demo_system::_sequent__TOP__9(Vibex_demo_system__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vibex_demo_system::_sequent__TOP__9\n"); );
    Vibex_demo_system* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    if (vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__trst_n) {
        if ((1U & (~ (IData)(vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_resp__DOT__empty_rclk)))) {
            vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_resp__DOT__fifo_rptr_gray_q 
                = vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_resp__DOT__fifo_rptr_gray_d;
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_resp__DOT__fifo_rptr_gray_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__trst_n) {
        if (vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_req__DOT__fifo_incr_wptr) {
            vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_req__DOT__fifo_wptr_gray_q 
                = vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_req__DOT__fifo_wptr_gray_d;
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_req__DOT__fifo_wptr_gray_q = 0U;
    }
...
VL_INLINE_OPT void Vibex_demo_system::_sequent__TOP__10(Vibex_demo_system__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vibex_demo_system::_sequent__TOP__10\n"); );
    Vibex_demo_system* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__i_fifo__DOT__gen_normal_fifo__DOT__fifo_wptr 
        = vlTOPp->__Vdly__ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__i_fifo__DOT__gen_normal_fifo__DOT__fifo_wptr;
    ...
    if (vlTOPp->rst_sys_ni) {
        if (vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_resp__DOT__fifo_incr_wptr) {
            vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_resp__DOT__fifo_wptr_q 
                = vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_resp__DOT__fifo_wptr_d;
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__i_dmi_cdc__DOT__i_cdc_resp__DOT__fifo_wptr_q = 0U;
    }
    vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__i_dm_csrs__DOT__i_fifo__DOT__gen_normal_fifo__DOT__u_fifo_cnt__DOT__wptr_wrap_cnt 
    ...
    if (vlTOPp->rst_sys_ni) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_uart__DOT__rx_current_byte_q = 0U;
    }
    vlTOPp->ibex_demo_system__DOT__u_uart__DOT__u_rx_fifo__DOT__gen_normal_fifo__DOT__u_fifo_cnt__DOT__wptr_wrap_cnt 
    ...
    vlTOPp->ibex_demo_system__DOT__u_uart__DOT__rx_baud_counter_q 
        = ((IData)(vlTOPp->rst_sys_ni) ? (IData)(vlTOPp->ibex_demo_system__DOT__u_uart__DOT__rx_baud_counter_d)
            : 0U);
...
VL_INLINE_OPT void Vibex_demo_system::_sequent__TOP__11(Vibex_demo_system__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vibex_demo_system::_sequent__TOP__11\n"); );
    Vibex_demo_system* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Variables
    CData/*0:0*/ __Vdlyvset__ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__imd_val_q__v0;
    CData/*0:0*/ __Vdlyvset__ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__imd_val_q__v1;
    CData/*0:0*/ __Vdlyvset__ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__imd_val_q__v2;
    CData/*0:0*/ __Vdlyvset__ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__imd_val_q__v3;
    QData/*33:0*/ __Vdlyvval__ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__imd_val_q__v0;
    QData/*33:0*/ __Vdlyvval__ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__imd_val_q__v2;
    // Body
    __Vdlyvset__ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__imd_val_q__v0 = 0U;
    __Vdlyvset__ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__imd_val_q__v1 = 0U;
    __Vdlyvset__ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__imd_val_q__v2 = 0U;
    __Vdlyvset__ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__imd_val_q__v3 = 0U;
    vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__instr_new_id_q 
        = ((IData)(vlTOPp->ibex_demo_system__DOT__rst_core_n) 
           & (IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__instr_new_id_d));
    vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__load_store_unit_i__DOT__fcov_mis_bus_err_1_q 
        = ((IData)(vlTOPp->ibex_demo_system__DOT__rst_core_n) 
           & (IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__load_store_unit_i__DOT__fcov_mis_bus_err_1_d));
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if (vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__mstack_en) {
            vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__u_mstack_csr__DOT__rdata_q 
                = vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__mstack_d;
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__u_mstack_csr__DOT__rdata_q = 4U;
    }
    vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__load_store_unit_i__DOT__fcov_mis_2_en_q 
        = ((IData)(vlTOPp->ibex_demo_system__DOT__rst_core_n) 
           & (IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__load_store_unit_i__DOT__fcov_mis_2_en_d));
    vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__gen_prefetch_buffer__DOT__prefetch_buffer_i__DOT__discard_req_q 
        = ((IData)(vlTOPp->ibex_demo_system__DOT__rst_core_n) 
    ...
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if (vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__load_store_unit_i__DOT__rdata_update) {
            vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__load_store_unit_i__DOT__rdata_q 
                = (0xffffffU & (vlTOPp->ibex_demo_system__DOT__host_rdata
                                [0U] >> 8U));
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__load_store_unit_i__DOT__rdata_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if (vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__mtval_en) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__u_mtval_csr__DOT__rdata_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if (vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__mstack_en) {
            vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__u_mstack_cause_csr__DOT__rdata_q 
                = vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__u_mcause_csr__DOT__rdata_q;
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__u_mstack_cause_csr__DOT__rdata_q = 0U;
    }
    vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__mcountinhibit_q 
        = ((IData)(vlTOPp->ibex_demo_system__DOT__rst_core_n)
            ? (IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__mcountinhibit_d)
            : 0U);
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if (vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__dscratch1_en) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__u_dscratch1_csr__DOT__rdata_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if (vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__dscratch0_en) {
            vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__u_dscratch0_csr__DOT__rdata_q 
                = vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__csr_wdata_int;
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__u_dscratch0_csr__DOT__rdata_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if (vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__mscratch_en) {
            vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__u_mscratch_csr__DOT__rdata_q 
                = vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__csr_wdata_int;
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__u_mscratch_csr__DOT__rdata_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__minstret_counter_i__DOT__counter_q = 0ULL;
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__mcycle_counter_i__DOT__counter_q = 0ULL;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if (vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__ex_block_i__DOT__gen_multdiv_fast__DOT__multdiv_i__DOT__div_en_internal) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__ex_block_i__DOT__gen_multdiv_fast__DOT__multdiv_i__DOT__div_by_zero_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if (vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__ex_block_i__DOT__gen_multdiv_fast__DOT__multdiv_i__DOT__div_en_internal) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__ex_block_i__DOT__gen_multdiv_fast__DOT__multdiv_i__DOT__op_numerator_q = 0U;
    }
    vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__controller_i__DOT__enter_debug_mode_prio_q 
        = ((IData)(vlTOPp->ibex_demo_system__DOT__rst_core_n) 
    ...
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__gen_cntrs__BRA__9__KET____DOT__gen_imp__DOT__mcounters_variable_i__DOT__counter_q = 0ULL;
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__gen_cntrs__BRA__8__KET____DOT__gen_imp__DOT__mcounters_variable_i__DOT__counter_q = 0ULL;
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__gen_cntrs__BRA__6__KET____DOT__gen_imp__DOT__mcounters_variable_i__DOT__counter_q = 0ULL;
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__gen_cntrs__BRA__5__KET____DOT__gen_imp__DOT__mcounters_variable_i__DOT__counter_q = 0ULL;
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__gen_cntrs__BRA__4__KET____DOT__gen_imp__DOT__mcounters_variable_i__DOT__counter_q = 0ULL;
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__gen_cntrs__BRA__3__KET____DOT__gen_imp__DOT__mcounters_variable_i__DOT__counter_q = 0ULL;
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__gen_cntrs__BRA__2__KET____DOT__gen_imp__DOT__mcounters_variable_i__DOT__counter_q = 0ULL;
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__gen_cntrs__BRA__1__KET____DOT__gen_imp__DOT__mcounters_variable_i__DOT__counter_q = 0ULL;
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__gen_cntrs__BRA__0__KET____DOT__gen_imp__DOT__mcounters_variable_i__DOT__counter_q = 0ULL;
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__gen_cntrs__BRA__7__KET____DOT__gen_imp__DOT__mcounters_variable_i__DOT__counter_q = 0ULL;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if (vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__ex_block_i__DOT__gen_multdiv_fast__DOT__multdiv_i__DOT__div_en_internal) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__ex_block_i__DOT__gen_multdiv_fast__DOT__multdiv_i__DOT__op_quotient_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if (vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__depc_en) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__u_depc_csr__DOT__rdata_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if (vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__mstack_en) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__u_mstack_epc_csr__DOT__rdata_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if (vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__ex_block_i__DOT__gen_multdiv_fast__DOT__multdiv_i__DOT__div_en_internal) {
            vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__ex_block_i__DOT__gen_multdiv_fast__DOT__multdiv_i__DOT__div_counter_q 
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__ex_block_i__DOT__gen_multdiv_fast__DOT__multdiv_i__DOT__div_counter_q = 0U;
    }
    vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__gen_prefetch_buffer__DOT__prefetch_buffer_i__DOT__branch_discard_q 
        = ((IData)(vlTOPp->ibex_demo_system__DOT__rst_core_n)
            ...
            : 0U);
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if (vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__mtvec_en) {
            vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__u_mtvec_csr__DOT__rdata_q 
                = ((IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__csr_mtvec_init)
                    ? 0x100001U : (1U | (0xffffff00U 
                                         & vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__csr_wdata_int)));
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__u_mtvec_csr__DOT__rdata_q = 1U;
    }
    vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__controller_i__DOT__do_single_step_q 
        = ((IData)(vlTOPp->ibex_demo_system__DOT__rst_core_n) 
           & (IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__controller_i__DOT__do_single_step_d));
    vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__gen_prefetch_buffer__DOT__prefetch_buffer_i__DOT__rdata_outstanding_q 
        = ((IData)(vlTOPp->ibex_demo_system__DOT__rst_core_n)
            ? ((IData)(vlTOPp->ibex_demo_system__DOT__core_instr_rvalid)
            ...
            : 0U);
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if ((2U & (IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__gen_trigger_regs__DOT__tmatch_value_we))) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__gen_trigger_regs__DOT__g_dbg_tmatch_reg__BRA__1__KET____DOT__u_tmatch_value_csr__DOT__rdata_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if ((2U & (IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__gen_trigger_regs__DOT__tmatch_control_we))) {
            vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__gen_trigger_regs__DOT__g_dbg_tmatch_reg__BRA__1__KET____DOT__u_tmatch_control_csr__DOT__rdata_q 
                = (1U & (vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__csr_wdata_int 
                         >> 2U));
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__gen_trigger_regs__DOT__g_dbg_tmatch_reg__BRA__1__KET____DOT__u_tmatch_control_csr__DOT__rdata_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if ((1U & (IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__gen_trigger_regs__DOT__tmatch_value_we))) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__gen_trigger_regs__DOT__g_dbg_tmatch_reg__BRA__0__KET____DOT__u_tmatch_value_csr__DOT__rdata_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if ((1U & (IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__gen_trigger_regs__DOT__tmatch_control_we))) {
            vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__gen_trigger_regs__DOT__g_dbg_tmatch_reg__BRA__0__KET____DOT__u_tmatch_control_csr__DOT__rdata_q 
                = (1U & (vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__csr_wdata_int 
                         >> 2U));
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__gen_trigger_regs__DOT__g_dbg_tmatch_reg__BRA__0__KET____DOT__u_tmatch_control_csr__DOT__rdata_q = 0U;
    }
    vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__g_branch_set_flop__DOT__branch_set_raw_q 
        = ((IData)(vlTOPp->ibex_demo_system__DOT__rst_core_n) 
           & (IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__branch_set_raw_d));
    vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__load_store_unit_i__DOT__lsu_err_q 
        = ((IData)(vlTOPp->ibex_demo_system__DOT__rst_core_n) 
           & (IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__load_store_unit_i__DOT__lsu_err_d));
    vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__controller_i__DOT__nmi_mode_q 
        = ((IData)(vlTOPp->ibex_demo_system__DOT__rst_core_n) 
           & (IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__controller_i__DOT__nmi_mode_d));
    vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__branch_jump_set_done_q 
        = ((IData)(vlTOPp->ibex_demo_system__DOT__rst_core_n) 
           & (IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__branch_jump_set_done_d));
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if (vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__mstatus_en) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__u_mstatus_csr__DOT__rdata_q = 0x10U;
    }
    vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__controller_i__DOT__exc_req_q 
        = ((IData)(vlTOPp->ibex_demo_system__DOT__rst_core_n) 
           & (IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__controller_i__DOT__exc_req_d));
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if (vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__cpuctrlsts_part_we) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__u_cpuctrlsts_part_csr__DOT__rdata_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if (vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__mie_en) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__u_mie_csr__DOT__rdata_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if (vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__dcsr_en) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__u_dcsr_csr__DOT__rdata_q = 0x40000003U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__controller_i__DOT__debug_cause_q 
            = ((0U != (IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__gen_trigger_regs__DOT__trigger_match))
                ? 2U : (((IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__controller_i__DOT__ebrk_insn_prio) 
                         ...
                         ? 1U : ((IData)(vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__haltreq)
                                  ? 3U : ((IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__controller_i__DOT__do_single_step_d)
                                           ? 4U : 0U))));
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__controller_i__DOT__debug_cause_q = 0U;
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__priv_lvl_q = 3U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if ((((IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__csr_we_int) 
            ...
            vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__gen_trigger_regs__DOT__u_tselect_csr__DOT__rdata_q 
                = (1U & ((2U <= vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__csr_wdata_int) 
                         | vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__csr_wdata_int));
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__gen_trigger_regs__DOT__u_tselect_csr__DOT__rdata_q = 0U;
    }
    vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__controller_i__DOT__illegal_insn_q 
        = ((IData)(vlTOPp->ibex_demo_system__DOT__rst_core_n) 
           & (IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__controller_i__DOT__illegal_insn_d));
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if (vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__load_store_unit_i__DOT__ctrl_update) {
            vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__load_store_unit_i__DOT__rdata_offset_q 
                = (3U & (IData)((vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__ex_block_i__DOT__alu_adder_result_ext 
                                 >> 1U)));
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__load_store_unit_i__DOT__rdata_offset_q = 0U;
    }
    vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__controller_i__DOT__load_err_q 
        = ((IData)(vlTOPp->ibex_demo_system__DOT__rst_core_n) 
           & (IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__lsu_load_err));
    vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__controller_i__DOT__store_err_q 
        = ((IData)(vlTOPp->ibex_demo_system__DOT__rst_core_n) 
    ...
    vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__load_store_unit_i__DOT__pmp_err_q 
        = ((IData)(vlTOPp->ibex_demo_system__DOT__rst_core_n) 
           & (IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__load_store_unit_i__DOT__pmp_err_d));
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if (vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__ex_block_i__DOT__gen_multdiv_fast__DOT__multdiv_i__DOT__mult_en_internal) {
            vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__ex_block_i__DOT__gen_multdiv_fast__DOT__multdiv_i__DOT__gen_mult_fast__DOT__mult_state_q 
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__ex_block_i__DOT__gen_multdiv_fast__DOT__multdiv_i__DOT__gen_mult_fast__DOT__mult_state_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if (vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__ex_block_i__DOT__gen_multdiv_fast__DOT__multdiv_i__DOT__div_en_internal) {
            vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__ex_block_i__DOT__gen_multdiv_fast__DOT__multdiv_i__DOT__md_state_q 
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__ex_block_i__DOT__gen_multdiv_fast__DOT__multdiv_i__DOT__md_state_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if (vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__load_store_unit_i__DOT__ctrl_update) {
            vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__load_store_unit_i__DOT__data_type_q 
                = vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__lsu_type;
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__load_store_unit_i__DOT__data_type_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if (vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__load_store_unit_i__DOT__ctrl_update) {
            vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__load_store_unit_i__DOT__data_sign_ext_q 
                = vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__lsu_sign_ext;
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__load_store_unit_i__DOT__data_sign_ext_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if (vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__load_store_unit_i__DOT__ctrl_update) {
            vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__load_store_unit_i__DOT__data_we_q 
                = vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__lsu_we;
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__load_store_unit_i__DOT__data_we_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if (vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__load_store_unit_i__DOT__addr_update) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__load_store_unit_i__DOT__addr_last_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if ((0x80000000U & vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__we_a_dec)) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__g_rf_flops__BRA__31__KET____DOT__rf_reg_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if ((0x40000000U & vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__we_a_dec)) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__g_rf_flops__BRA__30__KET____DOT__rf_reg_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if ((0x20000000U & vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__we_a_dec)) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__g_rf_flops__BRA__29__KET____DOT__rf_reg_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if ((0x10000000U & vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__we_a_dec)) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__g_rf_flops__BRA__28__KET____DOT__rf_reg_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if ((0x8000000U & vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__we_a_dec)) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__g_rf_flops__BRA__27__KET____DOT__rf_reg_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if ((0x4000000U & vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__we_a_dec)) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__g_rf_flops__BRA__26__KET____DOT__rf_reg_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if ((0x2000000U & vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__we_a_dec)) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__g_rf_flops__BRA__25__KET____DOT__rf_reg_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if ((0x1000000U & vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__we_a_dec)) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__g_rf_flops__BRA__24__KET____DOT__rf_reg_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if ((0x800000U & vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__we_a_dec)) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__g_rf_flops__BRA__23__KET____DOT__rf_reg_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if ((0x400000U & vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__we_a_dec)) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__g_rf_flops__BRA__22__KET____DOT__rf_reg_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if ((0x200000U & vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__we_a_dec)) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__g_rf_flops__BRA__21__KET____DOT__rf_reg_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if ((0x100000U & vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__we_a_dec)) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__g_rf_flops__BRA__20__KET____DOT__rf_reg_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if ((0x80000U & vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__we_a_dec)) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__g_rf_flops__BRA__19__KET____DOT__rf_reg_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if ((0x40000U & vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__we_a_dec)) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__g_rf_flops__BRA__18__KET____DOT__rf_reg_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if ((0x20000U & vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__we_a_dec)) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__g_rf_flops__BRA__17__KET____DOT__rf_reg_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if ((0x10000U & vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__we_a_dec)) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__g_rf_flops__BRA__16__KET____DOT__rf_reg_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if ((0x8000U & vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__we_a_dec)) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__g_rf_flops__BRA__15__KET____DOT__rf_reg_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if ((0x4000U & vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__we_a_dec)) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__g_rf_flops__BRA__14__KET____DOT__rf_reg_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if ((0x2000U & vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__we_a_dec)) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__g_rf_flops__BRA__13__KET____DOT__rf_reg_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if ((0x1000U & vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__we_a_dec)) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__g_rf_flops__BRA__12__KET____DOT__rf_reg_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if ((0x800U & vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__we_a_dec)) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__g_rf_flops__BRA__11__KET____DOT__rf_reg_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if ((0x400U & vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__we_a_dec)) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__g_rf_flops__BRA__10__KET____DOT__rf_reg_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if ((0x200U & vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__we_a_dec)) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__g_rf_flops__BRA__9__KET____DOT__rf_reg_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if ((0x100U & vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__we_a_dec)) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__g_rf_flops__BRA__8__KET____DOT__rf_reg_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if ((0x80U & vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__we_a_dec)) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__g_rf_flops__BRA__7__KET____DOT__rf_reg_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if ((0x40U & vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__we_a_dec)) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__g_rf_flops__BRA__6__KET____DOT__rf_reg_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if ((0x20U & vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__we_a_dec)) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__g_rf_flops__BRA__5__KET____DOT__rf_reg_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if ((0x10U & vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__we_a_dec)) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__g_rf_flops__BRA__4__KET____DOT__rf_reg_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if ((8U & vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__we_a_dec)) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__g_rf_flops__BRA__3__KET____DOT__rf_reg_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if ((4U & vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__we_a_dec)) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__g_rf_flops__BRA__2__KET____DOT__rf_reg_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if ((2U & vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__we_a_dec)) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__gen_regfile_ff__DOT__register_file_i__DOT__g_rf_flops__BRA__1__KET____DOT__rf_reg_q = 0U;
    }
    vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__load_store_unit_i__DOT__handle_misaligned_q 
        = ((IData)(vlTOPp->ibex_demo_system__DOT__rst_core_n) 
           & (IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__load_store_unit_i__DOT__handle_misaligned_d));
    vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__load_store_unit_i__DOT__ls_fsm_cs 
        = ((IData)(vlTOPp->ibex_demo_system__DOT__rst_core_n)
            ? (IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__load_store_unit_i__DOT__ls_fsm_ns)
            : 0U);
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__id_fsm_q = 0U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if ((1U & (IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__imd_val_we_ex))) {
            __Vdlyvval__ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__imd_val_q__v0 
                = vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT____Vcellinp__id_stage_i__imd_val_d_ex_i
                [0U];
            __Vdlyvset__ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__imd_val_q__v0 = 1U;
        }
    } else {
        __Vdlyvset__ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__imd_val_q__v1 = 1U;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if ((2U & (IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__imd_val_we_ex))) {
            __Vdlyvval__ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__imd_val_q__v2 
                = vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT____Vcellinp__id_stage_i__imd_val_d_ex_i
                [1U];
            __Vdlyvset__ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__imd_val_q__v2 = 1U;
        }
    } else {
        __Vdlyvset__ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__imd_val_q__v3 = 1U;
    }
    if (__Vdlyvset__ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__imd_val_q__v0) {
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__imd_val_q[0U] 
            = __Vdlyvval__ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__imd_val_q__v0;
    }
    if (__Vdlyvset__ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__imd_val_q__v1) {
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__imd_val_q[0U] = 0ULL;
    }
    if (__Vdlyvset__ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__imd_val_q__v2) {
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__imd_val_q[1U] 
            = __Vdlyvval__ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__imd_val_q__v2;
    }
    if (__Vdlyvset__ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__imd_val_q__v3) {
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__imd_val_q[1U] = 0ULL;
    }
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if (vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__mcause_en) {
            vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__u_mcause_csr__DOT__rdata_q 
                = vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__mcause_d;
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__u_mcause_csr__DOT__rdata_q = 0U;
    }
    ...
    vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__gen_cntrs__BRA__7__KET____DOT__gen_imp__DOT__mcounters_variable_i__DOT__counter 
        = ((0xffffff0000000000ULL & vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__gen_cntrs__BRA__7__KET____DOT__gen_imp__DOT__mcounters_variable_i__DOT__counter) 
           | vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__gen_cntrs__BRA__7__KET____DOT__gen_imp__DOT__mcounters_variable_i__DOT__counter_q);
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        if (vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__mepc_en) {
            vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__u_mepc_csr__DOT__rdata_q 
                = vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__mepc_d;
        }
    } else {
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__u_mepc_csr__DOT__rdata_q = 0U;
    }
    ...
    vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__controller_i__DOT__debug_mode_q 
        = ((IData)(vlTOPp->ibex_demo_system__DOT__rst_core_n) 
           & (IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__controller_i__DOT__debug_mode_d));
...
VL_INLINE_OPT void Vibex_demo_system::_sequent__TOP__12(Vibex_demo_system__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vibex_demo_system::_sequent__TOP__12\n"); );
    Vibex_demo_system* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    if (vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__instr_new_id_d) {
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__instr_rdata_c_id 
            = (0xffffU & vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__fetch_rdata);
    }
    if ((1U & (IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__gen_prefetch_buffer__DOT__prefetch_buffer_i__DOT__fifo_i__DOT__entry_en))) {
    ...
    if ((2U & (IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__gen_prefetch_buffer__DOT__prefetch_buffer_i__DOT__fifo_i__DOT__entry_en))) {
    ...
    if ((4U & (IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__gen_prefetch_buffer__DOT__prefetch_buffer_i__DOT__fifo_i__DOT__entry_en))) {
    ...
    if ((((IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__gen_prefetch_buffer__DOT__prefetch_buffer_i__DOT__valid_new_req) 
    ...
    if (((IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__pc_set) 
    ...
    if (vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__instr_new_id_d) {
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__instr_fetch_err_plus2 
            = (1U & ((((vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__gen_prefetch_buffer__DOT__prefetch_buffer_i__DOT__fifo_i__DOT__instr_addr_q 
                        & (3U == (3U & vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__fetch_rdata))) 
                       ...
                       [1U]) | (vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__gen_prefetch_buffer__DOT__prefetch_buffer_i__DOT__fifo_i__DOT__instr_addr_q 
                                & (((IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__gen_prefetch_buffer__DOT__prefetch_buffer_i__DOT__fifo_i__DOT__valid_q) 
                                    >> 1U) & (((IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__gen_prefetch_buffer__DOT__prefetch_buffer_i__DOT__fifo_i__DOT__err_q) 
                                               >> 1U) 
    ...
    if (vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__instr_new_id_d) {
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__instr_is_compressed_id 
            = (3U != (3U & vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__fetch_rdata));
    }
    if (vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__instr_new_id_d) {
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__instr_fetch_err 
    ...
    if (vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__instr_new_id_d) {
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__illegal_c_insn_id 
            = vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__illegal_c_insn;
    }
    if (vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__instr_new_id_d) {
    ...
    if ((1U & (IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__gen_prefetch_buffer__DOT__prefetch_buffer_i__DOT__fifo_i__DOT__entry_en))) {
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__gen_prefetch_buffer__DOT__prefetch_buffer_i__DOT__fifo_i__DOT__err_q 
            = ((6U & (IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__gen_prefetch_buffer__DOT__prefetch_buffer_i__DOT__fifo_i__DOT__err_q)) 
               | (1U & (IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__gen_prefetch_buffer__DOT__prefetch_buffer_i__DOT__fifo_i__DOT__err_d)));
    }
    if ((2U & (IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__gen_prefetch_buffer__DOT__prefetch_buffer_i__DOT__fifo_i__DOT__entry_en))) {
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__gen_prefetch_buffer__DOT__prefetch_buffer_i__DOT__fifo_i__DOT__err_q 
            = ((5U & (IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__gen_prefetch_buffer__DOT__prefetch_buffer_i__DOT__fifo_i__DOT__err_q)) 
               | (2U & (IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__gen_prefetch_buffer__DOT__prefetch_buffer_i__DOT__fifo_i__DOT__err_d)));
    }
    if ((4U & (IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__gen_prefetch_buffer__DOT__prefetch_buffer_i__DOT__fifo_i__DOT__entry_en))) {
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__gen_prefetch_buffer__DOT__prefetch_buffer_i__DOT__fifo_i__DOT__err_q 
            = ((3U & (IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__gen_prefetch_buffer__DOT__prefetch_buffer_i__DOT__fifo_i__DOT__err_q)) 
               | (4U & (IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__gen_prefetch_buffer__DOT__prefetch_buffer_i__DOT__fifo_i__DOT__err_d)));
    }
    if (((IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__pc_set) 
...
VL_INLINE_OPT void Vibex_demo_system::_sequent__TOP__13(Vibex_demo_system__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vibex_demo_system::_sequent__TOP__13\n"); );
    Vibex_demo_system* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    if (VL_UNLIKELY(((((5U == (IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__controller_i__DOT__ctrl_fsm_cs)) 
        ...
        VL_WRITEF("%t: Illegal instruction (hart 0) at PC 0x%x: 0x%x\n",
                  64,VL_TIME_UNITED_Q(1),32,vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__pc_id,
                  32,vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__instr_rdata_id);
    }
}

VL_INLINE_OPT void Vibex_demo_system::_multiclk__TOP__14(Vibex_demo_system__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vibex_demo_system::_multiclk__TOP__14\n"); );
    Vibex_demo_system* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__data_d 
        = vlTOPp->ibex_demo_system__DOT__g_dm_top__DOT__u_dm_top__DOT__dap__DOT__data_q;
...
VL_INLINE_OPT void Vibex_demo_system::_sequent__TOP__15(Vibex_demo_system__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vibex_demo_system::_sequent__TOP__15\n"); );
    Vibex_demo_system* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    ...
    vlTOPp->ibex_demo_system__DOT__core_instr_rvalid 
        = ((IData)(vlTOPp->rst_sys_ni) & (IData)(vlTOPp->ibex_demo_system__DOT__core_instr_gnt));
...
VL_INLINE_OPT void Vibex_demo_system::_multiclk__TOP__16(Vibex_demo_system__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vibex_demo_system::_multiclk__TOP__16\n"); );
    Vibex_demo_system* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
VL_INLINE_OPT void Vibex_demo_system::_sequent__TOP__17(Vibex_demo_system__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vibex_demo_system::_sequent__TOP__17\n"); );
    Vibex_demo_system* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
        ...
        = ((1U & (IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__gen_trigger_regs__DOT__trigger_match)) 
           | (0xfffffffeU & ((IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__gen_trigger_regs__DOT__tmatch_control_q) 
                             & (((vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__gen_prefetch_buffer__DOT__prefetch_buffer_i__DOT__fifo_i__DOT__instr_addr_q 
                                  << 1U) == vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__cs_registers_i__DOT__gen_trigger_regs__DOT__tmatch_value_q
                                 [1U]) << 1U))));
    vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__gen_prefetch_buffer__DOT__prefetch_buffer_i__DOT__valid_req_q 
        = ((IData)(vlTOPp->ibex_demo_system__DOT__rst_core_n) 
           & ((IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__gen_prefetch_buffer__DOT__prefetch_buffer_i__DOT__valid_req) 
              & (~ (IData)(vlTOPp->ibex_demo_system__DOT__core_instr_gnt))));
    vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__gen_prefetch_buffer__DOT__prefetch_buffer_i__DOT__fifo_i__DOT__valid_q 
        = ((IData)(vlTOPp->ibex_demo_system__DOT__rst_core_n)
            ? (IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__gen_prefetch_buffer__DOT__prefetch_buffer_i__DOT__fifo_i__DOT__valid_d)
            : 0U);
    ...
    if (vlTOPp->ibex_demo_system__DOT__rst_core_n) {
        ...
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__instr_valid_id_q 
            = ((IData)(vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__instr_valid_id_d) 
               & 1U);
    } else {
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__id_stage_i__DOT__controller_i__DOT__ctrl_fsm_cs = 0U;
        vlTOPp->ibex_demo_system__DOT__u_top__DOT__u_ibex_core__DOT__if_stage_i__DOT__instr_valid_id_q = 0U;
    }
